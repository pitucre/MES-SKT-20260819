                ...
                $("#resources_container .resource").each(function (i, item) {
                    ...
                    if (id) {
                        ...
                        if (strSummary) {
                            ...
                            //颜色样式设置
                            $(".controller-summary").css({ "color": "red", "font-weight": "800" });
                        }
                    }
                });

                $("#resources_container .resource .sandbox .snippet_json").each(function (i, item) {
                    $(item).css({ "display": "inline-grid" });
                });
            }
        });
    },
...
function LoadExportApiWordBtn() {
    ...
    var btnExport = "<div class='selectBox' style='position: absolute;margin: 0;padding: 0;margin-left: 1432px;top: 2.5px;'>" +
        ...
        "</div >" +
        "</div >";
    $("#header .swagger-ui-wrap").append(btnExport);
}
