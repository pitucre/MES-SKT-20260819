...
{
    public partial class OSPType : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "OSPTypeId";
            ...
            if (txtOSPTypeName.Text != "")
            {
                searchSettings.AddCondition("OSPTypeName", txtOSPTypeName.Text);
            }
            ...
            if (IsPostBack)
            {
                try
                {
                    ...
                    {
                        (new OSP()).Delete(Request.Form["hdnIdString"].ToString(), AccountController.GetCurrentUser().UserName);
