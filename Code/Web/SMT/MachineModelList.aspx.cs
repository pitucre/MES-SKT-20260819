...
{
    public partial class MachineModelList : BasePage
    {
        ...
        { 
            ...
            this.Master.RecordIDField = "ModelID";
            this.Master.DefaultSortExpression = "ModelID";
            ...
            if (this.IsPostBack)
            {
                if (Request.Form["hdnOperate"].ToLower() == "delete")
                {
                    ...
                    try
                    {
                        SKT.LeanMES.SMT.BLL.MachineModel bll = new SKT.LeanMES.SMT.BLL.MachineModel();
