...
{
    public partial class LoadingTypeList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "LoadingTypeId";
            this.Master.DefaultSortExpression = "LoadingTypeId DESC"; //也可不赋值

            SKT.Common.Model.SearchSettings searchSettings = new SKT.Common.Model.SearchSettings();
            searchSettings.AddCondition("TypeName", this.txtLoadingTypeName.Text.Trim());
            ...
            if (IsPostBack)
            {
                ...
                {
                    SKT.LeanMES.SMT.BLL.LoadingType bll = new SKT.LeanMES.SMT.BLL.LoadingType();
