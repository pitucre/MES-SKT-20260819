...
{
    public partial class StockCarList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "StockCarId";
            this.Master.DefaultSortExpression = "StockCarNumber";
            this.Master.DefaultSortDirection = SortDirection.Descending;

            SKT.Common.Model.SearchSettings searchSettings = new SKT.Common.Model.SearchSettings();
            searchSettings.AddCondition("StockCarNumber", Server.HtmlEncode(this.txtTurnoverTypeName.Value));
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (string.IsNullOrEmpty(e.Row.Cells[columnIndex_ModifyBy].Text) || e.Row.Cells[columnIndex_ModifyBy].Text == "&nbsp;" || e.Row.Cells[columnIndex_ModifyDateTime].Text.Contains("9999-12-31 00:00:00")) {
