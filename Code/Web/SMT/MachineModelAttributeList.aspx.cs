...
{
    public partial class MachineModelAttributeList : BasePage
    {
        ...
        { 
                ...
                this.Master.RecordIDField = "ModelAttrID";
                this.Master.DefaultSortExpression = "ModelAttrID";
                ...
                if (this.IsPostBack)
                {
                    if (Request.Form["hdnOperate"].ToLower() == "delete")
                    {
                        ...
                        try
                        {
                            SKT.LeanMES.SMT.BLL.MachineModelAttribute bll = new SKT.LeanMES.SMT.BLL.MachineModelAttribute();
