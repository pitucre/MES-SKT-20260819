...
{
    public partial class SearchMoldingDetail : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            this.Master.PageGridView = this.GridView1;
            this.Master.PageObjectDataSource = this.ObjectDataSource1;
            this.Master.RecordIDField = "ProcessNo";
            this.Master.DefaultSortExpression = "ProcessNo DESC"; //也可不赋值
        ...
        private DataTable BindData()
        {
            ...
            return bll.GetMoldingDetailExcle();
        ...
        private SKT.Common.Model.SearchSettings SetSearchSetting()
        {
            ...
            {
                searchSettings.AddCondition("ProdItemCode", txtItem.Text.Trim());
            }

            if (txtItem2.Text.Trim() != "")
            {
                searchSettings.AddCondition("SourceItemCode", txtItem2.Text.Trim());
            }

            if (txtItem3.Text.Trim() != "")
            {
                searchSettings.AddCondition("TargetItemCode", txtItem3.Text.Trim());
            }
            ...
            {
                searchSettings.ExtensionCondition = "CName like '" + txtUserName.Text.Trim() + "%'";
            }

            if (txtBeginTime.Text != "")
            {
                searchSettings.ExtensionCondition = (searchSettings.ExtensionCondition == "" ? "" : searchSettings.ExtensionCondition + " And ") + " CreateTime > '" + txtBeginTime.Text + "' ";
            }
