...
{
    public partial class PackRelationImport : System.Web.UI.Page
    {
        ...
        protected void linkUploadFile_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (fuPickList.HasFile)
                {
                    ...
                    Column += "F" + txtColumn2.Text + " as SerialNumber1";
        ...
        public void SavePackRelationImport(DataTable dt)
        {
            ...
            try
            {
                ...
                string CustomerOrder = txtCustomerOrder.Text;//订单

                list = bll.SavePackRelationImport(OrderNo, CustomerOrder, AccountController.GetCurrentUser().UserName, dt);
