...
{
    public partial class StationMatPreList : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var stationId = Request.QueryString["StationId"] == null ? "-1" : Request.QueryString["StationId"];
            
            SearchSettings searchSettings = new SearchSettings();
            searchSettings.AddCondition("ItemCode", this.txtItemCode.Text.Trim().Replace("'","''"));
            searchSettings.ExtensionCondition = "ItemCode Not IN (SELECT ItemCode FROM Basal_StationMateriel where stationId="+stationId+") ";
