<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ViewMaster.master" AutoEventWireup="true"
    CodeBehind="ShopOrderRelease.aspx.cs" Inherits="SKT.LeanMES.Web.Product.ShopOrderRelease"
...
<asp:Content ID="Content1" ContentPlaceHolderID="viewcontent" runat="server">
    <div style="text-align: center; margin-top: auto; color: Green;">
        <table class="ListTable" cellspacing="0" cellpadding="4" style="border-width: 0px; width: 100%; border-collapse: collapse;">
            ...
            <tr class="ListTableOddRow">
                <td align="right" class="Label1">是否打印条码
                </td>
                <td align="left">
    ...
    <script type="text/javascript">
        ...
        function Inity() {
            ...
            $("#btnRelease").click(function () {
                ...
                loading_id = layer.load(1, { shade: [0.5, '#000'] });
                setTimeout(function () {
                    /*check twice*/
                    if (checkIsReady(orderId)) {
                        ...
                        var ajax = SKT.LeanMES.Web.AjaxServices.AjaxShopOrder.ReleaseSO(ReleaseQty, orderId, itemids);
                        if (ajax.error != null) {
                        ...
                        if (Isprint=="1") {
                            ...
                            $("#<%=lbCanReleaseQty.ClientID %>").text(parseFloat(canReleaseQty) -parseFloat(ReleaseQty));
        ...
        function mesLabLabelPrint(list, isPopPdf) {
            ...
            //打印类型=2 ZPL连打方式，有些普通打印机可能不支持,会出现连接不上打印机的情况,这个时候需要变更打印类型=0 试试
        }
