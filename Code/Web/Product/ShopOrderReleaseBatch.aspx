<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ViewMaster.master" AutoEventWireup="true"
    CodeBehind="ShopOrderReleaseBatch.aspx.cs" Inherits="SKT.LeanMES.Web.Product.ShopOrderReleaseBatch"
...
<asp:Content ID="Content1" ContentPlaceHolderID="viewcontent" runat="server">
    ...
    <script type="text/javascript">
        ...
        var mySNQty = '<%=Request.QueryString["mySNQty"] %>';
        $(function () {
            $("#txtBatchQty").val(mySNQty);
            Inity();
            InityPrint();
            getDocumentInfo();
