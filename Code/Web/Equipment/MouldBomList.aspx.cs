...
{
    public partial class MouldBomList : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            searchSettings.AddCondition("BomName", Server.HtmlEncode(this.txtBomName.Text));
            ...
            if (IsPostBack)
            {
                ...
                if (Request.Form["hdnOperate"].ToLower() == "exportexcel")
                {
                    ...
                    String equipmentCode = txtBomName.Text;
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            //{
            //    //获取创建人
            //    string userName = e.Row.Cells[6].Text;
            //    if (!string.IsNullOrEmpty(userName))
            //    {
            //        MembershipInfo userInfo = user.GetInfo(userName);
            //        e.Row.Cells[6].Text = (userInfo == null) ? "" : userInfo.EmployeeCName;
            //    }
