...
{
    public partial class MouldInItem : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            searchSettings.ExtensionCondition = "  MouldBomId  in(select MouldId from Basal_ItemMouldRelation where isdelete=0 and ItemId= " + itemId + ")";

            //searchSettings.ExtensionCondition = " ItemId  in(select ItemId from Basal_ItemMouldRelation where isdelete=0 and MouldId= " + mouldId + ")";
