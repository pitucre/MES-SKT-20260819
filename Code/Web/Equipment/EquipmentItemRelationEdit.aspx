<%@ Page Language="C#" MasterPageFile="~/Masters/EditMaster.master" AutoEventWireup="True"
    CodeBehind="EquipmentItemRelationEdit.aspx.cs" Inherits="SKT.LeanMES.Web.Equipment.EquipmentItemRelationEdit" Title="Edit EquipmentItemRelation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="EditContent" runat="Server">
            ...
            <tr>
                <td class="Field" style="width: 45%; vertical-align: top;">
                    <iframe name="frmRoleChooseList" id="fromChooseList1" frameborder="0" style="width: 600px; height: 265px;"
                        src="ItemPreEquipment.aspx?EqCode=<%= Request.QueryString["EqCode"] %>"></iframe>
                </td>
    ...
    <script type="text/javascript">
        ...
        function getChooseValue(list) {
            if (temp == 1) {
                ...
                iframe2.src = "ItemInEquipment.aspx?EqCode="+list[0][1]+"";
      
                var iframe1 = document.getElementById("fromChooseList1");
                iframe1.src = "ItemPreEquipment.aspx?EqCode="+list[0][1]+"";
            }
            <%--  if (temp == 2) {
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            if (eqCode != "") {
                var iframe2 = document.getElementById("IfrHasChooseList");
                iframe2.src = "ItemInEquipment.aspx?EqCode=" + eqCode + "";
            }
        });
        ...
        function btnChooseOnClick(index) {
            ...
            if(equipmentItemRelationId==-1){                    
                var iframe1 = document.getElementById("fromChooseList1");
                iframe1.src = "ItemPreEquipment.aspx?EqCode="+eqCode+"";
