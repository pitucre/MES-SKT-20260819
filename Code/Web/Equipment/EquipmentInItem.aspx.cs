...
{
    public partial class EquipmentInItem : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            searchSettings.ExtensionCondition = "EquipmentId  in(select EquipmentId from Basal_PartOnEquiment where PartId= " + partId + ")";
