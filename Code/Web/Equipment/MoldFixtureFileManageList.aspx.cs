...
{
public partial class MoldFixtureFileManageList : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        AjaxPro.Utility.RegisterTypeForAjax(typeof(AjaxServices.AjaxEquipmentFileManage));
            ...
            this.Master.DefaultSortExpression = "MoldFixtureId DESC"; //也可不赋值
        ...
        if(IsPostBack) {
            if (Request.Form["hdnOperate"].ToLower() == "delete")
            {
                ...
                bll.MoldFixtureDelete(Request.Form["hdnIdString"].ToString(), AccountController.GetCurrentUser().UserName);
