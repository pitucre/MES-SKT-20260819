<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EditMaster.master" AutoEventWireup="true" CodeBehind="ReplaceMoldPersonEdit.aspx.cs" Inherits="SKT.LeanMES.Web.Equipment.ReplaceMoldPersonEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="EditContent" runat="Server">
    ...
    <table width="100%" class="EditeContentTable">
        ...
        <tr>
            <td class="Label1">申请编号<em>*</em></td>
            <td class="Field1">
                <label id="lblApplyNo"></label>

            </td>
        </tr>
        <tr>
            <td class="Label1">换模人<em>*</em>
            </td>
            <td class="Field1">
    ...
    <script type="text/javascript">
        ...
        var applyNo = '<%=Request.QueryString["ApplyNo"]%>';
        ...
        /*保存数据*/
        function Save() {
            var ajax = SKT.LeanMES.Web.Equipment.ReplaceMoldPersonEdit.EditOperator(id, $("#<%=this.hdOperator.ClientID%>").val());
            if (ajax.error != null) {
    ...
    function selectUser() {
        chooseFlag = 1;
        var searchCondition = " DepartName = '模具科'";
