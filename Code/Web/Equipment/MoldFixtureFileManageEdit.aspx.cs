...
{
public partial class MoldFixtureFileManageEdit : BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        AjaxPro.Utility.RegisterTypeForAjax(typeof(AjaxServices.AjaxEquipmentFileManage));
        AjaxPro.Utility.RegisterTypeForAjax(typeof(AjaxServices.AjaxMoldFixture));
            ...
            if (!this.IsPostBack)
        {
            ...
            {
                this.PageData = (new MoldFixture()).GetMoldFixture(idString);
            }
        }
    }
        ...
        /// 设置页面上的数据。
        /// </summary>
        private MoldFixtureFileInfo PageData
    {
        set
        {
