<%@ Page Language="C#" MasterPageFile="~/Masters/EditHeadMaster.master"
    AutoEventWireup="true" CodeBehind="EquipmentItemRelationEdits.aspx.cs" Inherits="SKT.LeanMES.Web.Equipment.EquipmentItemRelationEdits" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="GridviewContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function AddComponent() {
            ...
            dialog({ title: "<%=Resources.Pages.Product_BomMatAdd %>", src: openWinUrl, width: 650, height: 300 });--%>
           openWinUrl = "<%=SKT.LeanMES.Web.WebHelper.WebRoot %>" + "/AccessoryManagement/AccessoryAndItemRelationDtlEdit.aspx?name=AccessoryAndItemRelationDtlEdit&ID=" + idStr + "&BOMID=" + $("#<%=this.hdnBomId.ClientID %>").val();
            dialog({ title: "<%=Resources.Pages.Product_BomMatEdit %>", src: openWinUrl, width: 650, height: 300 });
        }
