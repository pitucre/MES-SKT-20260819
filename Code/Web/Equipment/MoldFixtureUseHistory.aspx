<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ListMaster.master" AutoEventWireup="true" CodeBehind="MoldFixtureUseHistory.aspx.cs" Inherits="SKT.LeanMES.Web.Equipment.MoldFixtureUseHistory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="GridviewContent" runat="server">
    <asp:GridView ID="GridView1" AutoGenerateColumns="false" runat="server" OnRowDataBound="GridView1_RowDataBound" style="table-layout:fixed;word-wrap:break-word;word-break:break-all">
        <Columns>
           ...
           <%-- <asp:BoundField DataField="Status" HeaderText="操作前状态" HeaderStyle-Width="80px"/> --%>
            ...
            <asp:BoundField DataField="OrderNO" HeaderText="机台号"  HeaderStyle-Width="100px"/>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="true" StartRowIndexParameterName="startRow"
        MaximumRowsParameterName="maxRows" SortParameterName="sortExpression" TypeName="SKT.LeanMES.Equipment.BLL.MoldFixture"
