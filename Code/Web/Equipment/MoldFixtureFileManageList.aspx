<%@ Page Language="C#" MasterPageFile="~/Masters/ListMaster.master" AutoEventWireup="True"
    CodeBehind="MoldFixtureFileManageList.aspx.cs" Inherits="SKT.LeanMES.Web.Equipment.MoldFixtureFileManageList" Title="EquipmentFileManage List Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="GridviewContent" Runat="Server">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="true" 
        ...
        TypeName="SKT.LeanMES.Equipment.BLL.MoldFixture" SelectMethod="GetMoldFixtureFileList" SelectCountMethod="GetCount">
        <SelectParameters>
    ...
    <script type="text/javascript">
        ...
        function Add() {
            openWinUrl = "<%=SKT.LeanMES.Web.WebHelper.WebRoot %>" + "/Equipment/MoldFixtureFileManageEdit.aspx?name=MoldFixtureFileManageListAdd&ID=-1";
            dialog({ title: "新增模治具文档", src: openWinUrl, width: 700, height: 400});
        }

        function Save() {
            var idStr = getOneRecordId();
            if (idStr == "") return false;
            openWinUrl = "<%=SKT.LeanMES.Web.WebHelper.WebRoot %>" + "/Equipment/MoldFixtureFileManageEdit.aspx?name=MoldFixtureFileManageListEdit&ID=" + idStr;
            dialog({ title: "编辑模治具文档", src: openWinUrl, width: 700, height: 400 });
        }
