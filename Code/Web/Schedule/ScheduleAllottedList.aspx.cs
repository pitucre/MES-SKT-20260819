...
{
    public partial class ScheduleAllottedList : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "AllotId";
            ...
            if (!string.IsNullOrEmpty(txtLineName.Value.Trim()))
            {
                searchSettings.AddCondition("LineName", Server.HtmlEncode(this.txtLineName.Value.Trim()));
            }
