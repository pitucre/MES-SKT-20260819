<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EditMaster.master" AutoEventWireup="true" CodeBehind="StockListAddPosition.aspx.cs" Inherits="SKT.LeanMES.Web.Plan.StockListAddPosition" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="EditContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Save() {
            ...
            var ajax = SKT.LeanMES.Web.AjaxServices.AjaxStockList.AddStockListPosition(planOrderNo, mainItemCode, position, num, equipqmentId, feederType, area);
            if (ajax.error != null) {
