<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ViewMaster.master" AutoEventWireup="true"
    CodeBehind="PlanSchedulResouceView.aspx.cs" Inherits="SKT.LeanMES.Web.Plan.PlanSchedulResouceView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="viewcontent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function addDetail(entity, tableName, lineId, lineName, planQty) {
            ...
            cell.innerHTML = entity.ResName + " <input type=\"hidden\" class=\"hdLineId\" value=\"" + entity.LineId + "\" />"
            + "<input type=\"text\" name=\"txtLineName\"  IsRequired='1' class=\"TextBox\" value=\"" + entity.ResName + "\" disabled=\"disabled\" style=\" width:100px;display:none;\" >"
            ...
            cell.align = "center";
            cell.className = "Field";
            cell.innerHTML = entity.FPlanFinishDate;
            //面别
            ...
            intiDatepicker($(tdObj[2]).find(".startDate"));

            //if (planType != 1) {
            //    $('#tblExpand tr').find('td:eq(1),td:eq(5),td:eq(6), th:eq(1), th:eq(5), th:eq(6)').hide();
            //}
        }
