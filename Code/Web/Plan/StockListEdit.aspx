<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EditHeadMaster.master" AutoEventWireup="true" CodeBehind="StockListEdit.aspx.cs" Inherits="SKT.LeanMES.Web.Plan.StockListEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="GridviewContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function AddReplaceItem() {
            ...
            openWinUrl = "<%=SKT.LeanMES.Web.WebHelper.WebRoot %>" + "/Plan/StockListAddReplaceItem.aspx?name=Plan_AddReplaceItem&ID=" + id + "&PlanOrderNo=" + linePlanNo + "&MainItemCode=" + mainItemCode + "&Position=" + position;
            dialog({ title: "<%=Resources.Pages.Plan_AddReplaceItem %>", src: openWinUrl, width: 800, height: 350 });
        }

        function AddPosition() {
            openWinUrl = "<%=SKT.LeanMES.Web.WebHelper.WebRoot %>" + "/Plan/StockListAddPosition.aspx?name=Plan_AddPosition&PlanOrderNo=" + linePlanNo;
