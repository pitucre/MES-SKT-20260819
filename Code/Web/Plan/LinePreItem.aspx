<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ChooseListMaster.master" AutoEventWireup="true" CodeBehind="LinePreItem.aspx.cs" Inherits="SKT.LeanMES.Web.Plan.LinePreItem" %>
...
<table class="EditeContentTable" width="100%">
        <tr>
            ...
            <td class="Field2">
              <asp:TextBox ID="txtLineName" runat="server" CssClass="TextBox" Width="80%"></asp:TextBox>
            </td>
        </tr>
    </table>
</asp:Content>
