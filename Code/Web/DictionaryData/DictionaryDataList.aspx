<%@ Page Language="C#" MasterPageFile="~/Masters/ListMaster.master" AutoEventWireup="True"
    CodeBehind="DictionaryDataList.aspx.cs" Inherits="SKT.LeanMES.Web.DictionaryData.DictionaryDataList"
    Title="DictionaryData List Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="GridviewContent" runat="Server">
    <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" OnRowDataBound="GridView1_RowDataBound">
        <Columns>
            <%-- To Do --%>
            <asp:BoundField DataField="Name" HeaderText="单位名称" HeaderStyle-Width="120px"/>
    ...
    <script type="text/javascript">
        ...
        function Add() {
            openWinUrl = "<%=SKT.LeanMES.Web.WebHelper.WebRoot %>" + "/DictionaryData/DictionaryDataEdit.aspx?name=DictionaryDataAdd&ID=-1";
            dialog({ title: "<%=Resources.Pages.DictionaryDataAdd %>", src: openWinUrl, width: 650, height: 400 });
        }

        function Edit() {
            var idStr = getOneRecordId();
            if (idStr == "") return false;
            openWinUrl = "<%=SKT.LeanMES.Web.WebHelper.WebRoot %>" + "/DictionaryData/DictionaryDataEdit.aspx?name=DictionaryDataEdit&ID=" + idStr;
            dialog({ title: "<%=Resources.Pages.DictionaryDataEdit %>", src: openWinUrl, width: 600, height: 400 });
        }
