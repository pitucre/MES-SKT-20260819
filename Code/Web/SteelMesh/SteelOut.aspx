<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EditMaster.master" AutoEventWireup="true"
    CodeBehind="SteelOut.aspx.cs" Inherits="SKT.LeanMES.Web.SteelMesh.SteeOut" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="EditContent" runat="server">
    <table class="EditeContentTable" width="100%">
        <tr>
            ...
            <td class="Field1">
                <asp:Label ID="lbSteelMeshName" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="Label1">
        ...
        <tr>
            ...
            <td class="Field1" id="tdThick">
                <asp:Label ID="lbThick" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="Label1">
        ...
        <tr>
            ...
            <td class="Field1" id="tdEnterDate">
                <asp:Label ID="lbEnterDate" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="Label1">
            ...
            <td class="Field1" id="tdBarNo">
                <asp:Label ID="lbBarNo" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="Label1">
            ...
            <td class="Field1" id="tdUserCount">
                <asp:Label ID="lbUserCount" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="Label1">
    ...
    var Id = <%= Request.QueryString["ID"] == null ? -1 : Convert.ToInt32(Request.QueryString["ID"].ToString())%>;
     var chooseFlag = -1;
        ...
        function Save() {
            var txtSteelName = $("#<%=this.lbSteelMeshName.ClientID %>").html();
            var lineId = $("#<%=this.hdnLineId.ClientID %>").val();
            var steelType =  $("#ddlOutType").val();//出入库类型为下拉列表的值
            var useCount = $("#<%=this.lbUserCount.ClientID %>").html();//已使用次数
            ...
            if(parseInt(useCount)>=parseInt(liftCount)){
             ...
             var entity = {};
             entity.SteelHistoryId=-1;
             entity.SteelId = Id;
             entity.LineId = parseInt(lineId);
             entity.OperateType = 2;
             entity.SteelType = parseInt(steelType);
             entity.Operator = $("#<%=this.hdnRequestor.ClientID %>").val();
             entity.Remark="";

            var ajax = SKT.LeanMES.Web.AjaxServices.AjaxSteelHistory.SteelRecordEdit(entity);
            if (ajax.error != null) {
            ...
            alert('<%=Resources.Messages.SaveInSuccess%>');
                $("#<%=this.txtLine.ClientID %>").val("");
                $("#<%=this.hdnLineId.ClientID %>").val("-1");
                parent.window.UpdateList(txtSteelName);
        }
    </script>
</asp:Content>
