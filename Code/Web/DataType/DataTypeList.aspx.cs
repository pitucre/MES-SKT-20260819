...
{
    public partial class DataTypeList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "DataTypeId";
            this.Master.DefaultSortExpression = "DataTypeId";
            this.Master.DefaultSortDirection = SortDirection.Descending;

            SKT.Common.Model.SearchSettings searchSettings = new SKT.Common.Model.SearchSettings();
            searchSettings.AddCondition("DataTypeName", Server.HtmlEncode(this.txtName.Text));
            searchSettings.AddCondition("[Category]", Server.HtmlEncode(this.ddlCat.SelectedItem.Value.Trim()));
