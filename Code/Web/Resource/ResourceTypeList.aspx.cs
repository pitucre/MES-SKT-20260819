...
{
    public partial class ResourceTypeList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "ResourceTypeId";
            this.Master.DefaultSortExpression = "ResourceTypeId DESC";
            ...
            if (this.IsPostBack)
            {
                ...
                if (Request.Form["hdnOperate"].ToLower() == "delete")
                {
                    try
                    {
                        SKT.LeanMES.Resource.BLL.ResourceType bll = new LeanMES.Resource.BLL.ResourceType();
