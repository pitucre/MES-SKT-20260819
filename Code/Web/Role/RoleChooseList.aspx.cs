...
{
    public partial class RoleChooseList : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            searchSettings.ExtensionCondition = "[RoleId] NOT IN (SELECT [RoleId] FROM [SYS_UsersInRole] WHERE [UserId] = " + Request.QueryString["ID"] + ") ";
