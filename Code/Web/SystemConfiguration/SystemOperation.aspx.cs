...
{
    public partial class SystemOperation : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            searchSettings.AddCondition("PageName", this.txtPageName.Text.Trim());
            searchSettings.AddCondition("OederNo", this.txtOederNo.Text.Trim());
            searchSettings.AddCondition("ModuleName", this.txtModuleName.Text.Trim());
