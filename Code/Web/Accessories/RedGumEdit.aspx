<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RedGumEdit.aspx.cs" Inherits="SKT.LeanMES.Web.Accessories.RedGumEdit" MasterPageFile="~/Masters/EditMaster.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="EditContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Save() {
            ...
            if (!isNumber(slePartId) || slePartId*1===0) {
