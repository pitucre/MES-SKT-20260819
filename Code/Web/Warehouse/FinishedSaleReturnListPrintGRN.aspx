<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinishedSaleReturnListPrintGRN.aspx.cs" Inherits="SKT.LeanMES.Web.Warehouse.FinishedSaleReturnListPrintGRN"
...
<asp:Content ID="Content1" ContentPlaceHolderID="viewcontent" runat="server">
    ...
    <table width="100%" class="EditeContentTable">
        <tr>
            <td class="Label2">销退单号<em>*</em>
            </td>
            <td class="Field2">
                <input type="text" id="txtPoNumber" class="TextBox" disabled="disabled" isrequired='1' />
                <%--<input type="button" id="btnSelectPo" class="ButtonBox" value="..." onclick="selectPoNumber()" />--%>
            ...
            <td class="Field2">
                ...
                <input type="text" id="txtItemName" class="TextBox" isrequired='1' disabled="disabled" value="" />
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            GetSaleReturnDataById(SaleReturnDtlId);
        ...
        function GetSaleReturnDataById() {
            ...
            $("#txtPoNumber").val(list[0].SaleReturnNo);
            $("#txtItemName").val(list[0].ItemCode);
            $("#hdnItemId").val(list[0].ItemId);
            $("#hdnRowId").val(list[0].SaleReturnRowId);
            $("#hdnVendorCode").val(list[0].CustomerCode);
            $("#<%=this.lblVendorCode.ClientID %>").text(list[0].CustomerCode);
            $("#<%=this.lblVendorName.ClientID %>").text(list[0].CustomerName);
            $("#<%=this.lblPOQty.ClientID %>").text(list[0].SaleReturnQty);
            $("#<%=this.lblPrintQty.ClientID %>").text(list[0].PrintQty || 0);
            itemAllQty = list[0].SaleReturnQty;
            alreadyQty = list[0].PrintQty;
        ...
        function mesLabLabelPrint(printType) {
            ...
            try {
                ...
                sendPrintContent(JSON.stringify(printdata), printName, 1, labelDocumentId, function (res, ws, msg) {
                    alert("打印完成!");
