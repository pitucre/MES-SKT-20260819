<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccessoryReturn.aspx.cs" Inherits="SKT.LeanMES.Web.MobileApp.AccessoryReturn" %>
        ...
        <div data-role="page" id="accessoryReturnPage">
            <div data-role="header" data-position="fixed" style="position: fixed">
                <h5 style="padding: 4px; margin: 0px;">
                    <label style="font-size: 17px !important; font-weight: bold; color: #fff">辅料退回</label>
                </h5>
