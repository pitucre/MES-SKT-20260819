<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccessoryStir.aspx.cs" Inherits="SKT.LeanMES.Web.MobileApp.AccessoryStir" %>
        ...
        <div data-role="page" id="accessoryThawPage">
            <div data-role="header" data-position="fixed" style="position: fixed">
                <h5 style="padding: 4px; margin: 0px;">
                    <label style="font-size: 17px !important; font-weight: bold; color: #fff">辅料搅拌</label>
                </h5>
