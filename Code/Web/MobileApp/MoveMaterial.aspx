<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoveMaterial.aspx.cs" Inherits="SKT.LeanMES.Web.MobileApp.MoveMaterial"%>
...
<form id="form1" runat="server" onsubmit="return false;">
    <sdpui>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                $("#txtGRN").keydown(function () {
                    ...
                    if (curKey == 13) {
                        ...
                        var ajax = SKT.LeanMES.Web.AjaxServices.AjaxSWMS.MoveMaterialScanGRN($("#txtReuestOrder").val(), $("#txtGRN").val(), cbarcode);
                        if (ajax.error != null) {
                            setMsg(ajax.error.Message, "red");
                            return;
                        }
                        setMsg($("#txtGRN").val() + "移库成功", "red");
                        $("#txtGRN").val("");
                        cbarcode = ajax.value;
                    }
                });
            ...
            function Save() {
                setMsg("", "");
                var ajax = SKT.LeanMES.Web.AjaxServices.AjaxSWMS.SaveMoveMaterial($("#txtReuestOrder").val(), cbarcode);
                if (ajax.error != null) {
                    setMsg(ajax.error.Message, "red");
                    return;
                }
