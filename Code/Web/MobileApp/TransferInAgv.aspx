<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferInAgv.aspx.cs" Inherits="SKT.LeanMES.Web.MobileApp.TransferInAgv" %>
        ...
        <script type="text/javascript">
            ...
            $("#txtStatrAgv").on("keydown", function (e) {
                ...
                if (curKey == 13) {
                    ...
                    var entity = {};
                    entity.CheckType = 1;//加载发料类型的AGV地标码
