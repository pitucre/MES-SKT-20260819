<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GroupInde.aspx.cs" Inherits="SKT.LeanMES.Web.GroupIndex"
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .login-form {
            width: 1028px;
            height: 488px;
            background-image: URL(Content/login/login2/login_form2.png);
            background-repeat: no-repeat;
            margin: auto auto;
        }
        ...
        .login-input-group .zh-cn {
            background: url(Content/login/login2/zh_cn1.png) left top no-repeat;
            right: 5px;
            text-align: left;
        }

        .login-input-group .en {
            background: url(Content/login/login2/en1.png) left top no-repeat;
            right: 8px;
            text-align: right;
        }
        ...
        .ver {
            color: #909090;
            font-size:14px; /*12px;*/
            font-family:'微软雅黑'; /*Verdana, Arial,Geneva, Tahoma, sans-serif,'微软雅黑';*/
            text-align: right;
            margin-top: 10px;
            width: 380px;
            line-height: 16px;
        ...
        .login-label {
            ...
            /*border-right: 1px solid #dedcdc;*/  /*#bdbdbd;*/
        }
         #passwd::-ms-clear, #passwd::-ms-reveal{display: none;}
        -->
    </style>
</head>
<body>
    <form id="form1" runat="server">
                   ...
                   <%-- <div class="split error-msg" id="msg"></div>--%>
                    <div class="clear form-group">
                        <div class="form-control">
                            <label for="Organization" class="u_Organization login-label">
                                <img src="Content/login/login2/ognization.png" style="height:33px;margin-left:10px;"/>
                            </label>
                             <select id="Organization" name="Organization" style="width:380px;height:54px;padding-left:50px;border:1px;background-color:rgb(232, 240, 254) !important;font-size: 18px;font-family: Microsoft YaHei UI,Verdana;"></select>
                        </div>
                        <div style="height: 15px;"></div>
                        <div class="form-control">
                            <label for="userName" class="u_user login-label">
                                <img src="Content/login/login2/account.png" style="height:33px;margin-left:10px;"/>
                            </label>
                            <input type="text" id="userName" name="userName" value="" placeholder="请输入帐号" class="input" title="请输入帐号" />
                        </div>
                        <div style="height: 15px;"></div>
                        <div class="form-control">
                            <label for="password" class="u_pwd login-label">
                                <img src="Content/login/login2/pwd.png" style="height:33px;margin-left:10px;"/>
                            </label>
                            <input type="password" id="passwd" name="passwd" value="" placeholder="请输入密码" class="input" title="请输入密码" />
                            <label for="password" class="u_pwd login-label"  style="position:absolute;left:88%;top:55%;">
                                <img src="Content/login/login2/hide.png"  id="hideorshow" style="height:33px;"/>
                            </label>
                        </div>
                        <div class="form-control">
                            <div class="input-group" style="float:left;width:25%;">
                                <i class="checkbox-btn">
                                    <input type="checkbox" id="rmbme" name="rmbme" class="checkbox" /><span style="vertical-align: middle;" id="spMemory">记住我</span></i>
                                     <%--&nbsp;&nbsp;&nbsp;&nbsp;<select id="Organization" name="Organization" style="width:120px;height:100%;padding-left:20px;border-radius:8px;"></select>--%>
                            </div>
                             <div class="split error-msg" id="msg" style="float:right;width:70%;"></div>
                        </div>
                        <div class="form-control" id="login_button" style="position: static;">
                            <button type="button" id="loginbtn" class="btn btn-primary" onclick="login()">登&nbsp;&nbsp;录</button>
                        </div>
                        <div class="ver"><span id="spVersions">产品版本：</span><%=SKT.LeanMES.Web.AppCode.Utility.GetAssemblyInfo.GetApplicationVersion() %> <span id="version_name"><%=SKT.LeanMES.Web.AppCode.Utility.GetAssemblyInfo.GetApplicationGroupVersionName() %></span></div>
                    </div>
                </div>
        ...
        <script src="Content/login/js/grouplogin.2.0.js?v=4"></script>
        ...
        <script type="text/javascript">
            ...
            var _VersionName = "<%=SKT.LeanMES.Web.AppCode.Utility.GetAssemblyInfo.GetApplicationGroupVersionName() %>";
            if (_msg != '') {
                setLoginInfo(_msg);
            }
        </script>
