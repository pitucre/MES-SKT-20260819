...
{
    public partial class TurnoverGroupView : BasePage
    {
        ...
        private TurnoverGroupInfo PageData
        {
            set
            {
                this.lblTurnoverGroupName.Text = value.TurnoverGroupName;
                this.lblMinStowQty.Text = value.MinQty.ToString();
                this.lblMaxStowQty.Text = value.MaxQty.ToString();
