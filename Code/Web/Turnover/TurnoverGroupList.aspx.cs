...
{
    public partial class TurnoverGroupList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "TurnoverGroupId";
            ...
            searchSettings.AddCondition("TurnoverGroupName", Server.HtmlEncode(this.txtTurnoverGroupName.Value));
            searchSettings.AddCondition("ItemCode", Server.HtmlEncode(this.txtItemCode.Value));
