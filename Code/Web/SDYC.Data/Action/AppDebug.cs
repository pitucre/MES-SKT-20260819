...
namespace SDYC.Data
{
    ...
    public static class AppDebug
    {
        ...
        private const string _Key = "AppDebug_RecordSQL";// "integrated.Data.AppDebug_RecordSQL";
        private const string _KeyTime = "AppDebug_RecordTime";// "integrated.Data.AppDebug_RecordTime";
        /// <summary>
        /// 获取调试信息
        /// </summary>
