...
namespace SDYC.Data
{
    ...
    public static class AppConfig
    {
        ...
        public static void SetApp(string key, string value)
        {
            ...
            {
                SDYC.Data.Log.WriteLogToTxt(err);
            }
        }
        /// <summary>
        ...
        public static string GetConn(string key, out string providerName)
        {
            ...
            //        return GetConn(key);
            //    }
            //IniFiles ini = new IniFiles(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\iPlatform.ini");
            //string strServer = ini.GetString("DB", "ServerName", "");
            //string strDataBaseName = ini.GetString("DB", "DataBaseName", "");
            //string strUserName = ini.GetString("DB", "UID", "");
            //string strPassWord = ini.GetString("DB", "PWD", "");

            //string strServer = System.Configuration.ConfigurationSettings.AppSettings["Server"];
            //string strDataBaseName = System.Configuration.ConfigurationSettings.AppSettings["DataBaseName"];
            //string strUserName = System.Configuration.ConfigurationSettings.AppSettings["UserName"];
            //string strPassWord = System.Configuration.ConfigurationSettings.AppSettings["PassWord"];

            // < add key = "U9ConnString" value = "server=10.15.2.10;uid=sa;pwd=Gterpsa@!2022;database=U9CEDB-1;Pooling=True;max pool size=500;Connect Timeout=600" />
            //strConnectionString = "server=10.15.40.10;uid=sa;pwd=Gtzmn##2023;database=MomData;Pooling=True;max pool size=500;Connect Timeout=600";
            //strConnectionString = "server=10.15.40.10;uid=sa;pwd=Gtzmn##2023;database=MomData;Pooling=True;max pool size=500;Connect Timeout=600";

            string strConnectionString = SQLHelper.MESConnString;
           // strConnectionString = "server=10.15.40.15;uid=sa;pwd=Gtmom##!!2023;database=MomData;Pooling=True;max pool size=500;Connect Timeout=600";

            //  strConnectionString = "server=10.15.2.10;uid=sa;pwd=Gterpsa@!2022;database=U9CEDB-1;Pooling=True;max pool size=500;Connect Timeout=600";
        ...
        public static class Cache
        {
            ...
            public static string NoCacheTables
            {
                ...
                set
                {
                    ...
                    SDYC.Data.Cache.AutoCache.NoCacheTables = null;
                }
            }
        ...
        public static class Log
        {
            ...
            /// <summary>
            /// integrated.Data.Log 类记录数据库异常日志 - 数据库链接配置
            /// </summary>
