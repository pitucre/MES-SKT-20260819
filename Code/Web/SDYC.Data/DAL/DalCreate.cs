...
namespace SDYC.Data
{
    ...
    internal class DalCreate
    {
        ...
        private const string TxtClient = "integrated.Data.TxtClient";
        private const string XmlClient = "integrated.Data.XmlClient";
        private const string XHtmlClient = "integrated.Data.XHtmlClient";
