...
{
    public partial class OffLineLabelConfigDetailList : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            searchSettings.ExtensionCondition += " LabelID=" + idString+" ";
            ...
            if (IsPostBack)
            {
                if (Request.Form["hdnOperate"].ToLower() == "delete")
                {
                    try
                    {
                        ...
                        bll.DeleteOffLineLabelConfigDetai(Request.Form["hdnIdString"].ToString(), AccountController.GetCurrentUser().UserName);
