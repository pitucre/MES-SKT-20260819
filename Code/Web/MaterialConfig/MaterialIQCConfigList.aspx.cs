...
{
    public partial class MaterialIQCConfigList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            searchSettings.AddCondition("CheckType", this.txtCheckResult.Text);
            ...
            if (IsPostBack)
            {
                if (Request.Form["hdnOperate"].ToLower() == "delete")
                {
                    try
                    {
                        SKT.LeanMES.MaterialConfig.BLL.MaterialIQCConfig bll = new SKT.LeanMES.MaterialConfig.BLL.MaterialIQCConfig();
