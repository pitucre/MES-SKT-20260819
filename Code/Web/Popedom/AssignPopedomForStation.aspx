<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EditMaster.master" AutoEventWireup="true" CodeBehind="AssignPopedomForStation.aspx.cs" Inherits="SKT.LeanMES.Web.Popedom.AssignPopedomForStation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="EditContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Save() {
            ...
            var ajax = SKT.LeanMES.Web.AjaxServices.AjaxAccount.AssignPopodomToRole(roleId, popedomString);
            if (ajax.error != null) {
        ...
        */
        ...
        function showPopedomUsers(popedom) {
            var url = "<%= SKT.LeanMES.Web.WebHelper.WebRoot %>/User/PopedomUsersList.aspx?name=PopedomUsersList&amp;Popedom=" + popedom + "&rnd=" + Math.random();
        ...
        function exportPopedomUsers(popedomText, popedom) {
            ...
            setTimeout(function () {
                ...
                var ajax = SKT.LeanMES.Web.AjaxServices.AjaxAccount.ExportPopedomUser(popedom);
                if (ajax.error != null) {
                    alert(ajax.error.Message);
                    return false;
                }
