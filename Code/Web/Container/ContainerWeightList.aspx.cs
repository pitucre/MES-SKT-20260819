...
{
    public partial class ContainerWeightList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "ContainerWeightId";
            ...
            {
                searchSettings.AddCondition("ItemCode", txtMainItemCode.Text.Trim().Replace("'", "''"));
            }
            if (ddlType.SelectedValue != "-1")
            {
                searchSettings.AddCondition("PackingType", ddlType.SelectedValue);
            }
            ...
            if (this.IsPostBack)
            {
                ...
                if (Request.Form["hdnOperate"].ToLower() == "delete")
                {
                    ...
                    try
                    {
                        SKT.LeanMES.Container.BLL.ContainerWeight bll = new SKT.LeanMES.Container.BLL.ContainerWeight();
