<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EditMaster.master" AutoEventWireup="true"
    CodeBehind="UsersInSupplier.aspx.cs" Inherits="SKT.LeanMES.Web.Supplier.UsersInSupplier" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="EditContent" runat="server">
    ...
    <table class="EditeContentTable" width="100%">
        <tr>
            <td class="Label" style="width: 45%; text-align: center; font-weight: bold;">
                <asp:Label ID="Label5" runat="server" Text="选择用户"></asp:Label>
            </td>
            <td class="Label" style="width: 10%; text-align: center;">
            </td>
            <td class="Label" style="width: 45%; text-align: center; font-weight: bold;">
                <asp:Label ID="Label6" runat="server" Text="供应商的用户"></asp:Label>
            </td>
        </tr>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            iframe1.src = "<%=SKT.LeanMES.Web.WebHelper.WebRoot %>" + '/User/UserOfSupplierChooseList.aspx?ID=<%= Request.QueryString["ID"] %>';
            ...
            iframe2.src = "<%=SKT.LeanMES.Web.WebHelper.WebRoot %>" + '/Supplier/SupplierUsersList.aspx?ID=<%= Request.QueryString["ID"] %>';
        ...
        function btnChooseOnClick(index) {
            ...
            /*分配用户给供应商*/
            if (index == 0) {
                var ajax = SKT.LeanMES.Web.AjaxServices.AjaxUsersInSupplier.AssignUsersToSuplier(SupplierId, UserIdString, UserName);
                if (ajax.error != null) {
                ...
                var ajax = SKT.LeanMES.Web.AjaxServices.AjaxUsersInSupplier.RemoveUsersFromSuplierint(SupplierId, UserIdString, UserName);
                if (ajax.error != null) {
                    alert(ajax.error.Message);
                    return;
                }
