<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ChooseListMaster.master" AutoEventWireup="true" CodeBehind="ItemChooseList.aspx.cs" Inherits="SKT.LeanMES.Web.Supplier.ItemChooseList" %>
...
<asp:GridView ID="GridView1" AutoGenerateColumns="false" runat="server" DataSourceID="ObjectDataSource1">
        <Columns>
            ...
            <asp:BoundField DataField="ItemRev" HeaderText="版本" />
        </Columns>
    </asp:GridView>
