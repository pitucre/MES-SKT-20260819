...
{
    public partial class UsersInSupplier : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            AjaxPro.Utility.RegisterTypeForAjax(typeof(AjaxServices.AjaxUsersInSupplier));
        ...
        private void BuildOperateButton()
        {
            ...
            if (Common.Account.BLL.Users.CheckUserIsWarrantted(userId, 10200103)) //分配用户权限组
            {
                ...
                this.btnLeftChoose.Attributes["title"] = "分配用户给供应商";
            }
            else
            {
            ...
            if (Common.Account.BLL.Users.CheckUserIsWarrantted(userId, 10200103)) //分配用户权限组
            {
                ...
                this.btnRightChoose.Attributes["title"] = "移除供应商中的用户";
            }
            else
            {
