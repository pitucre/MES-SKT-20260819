...
{
    public partial class MaintenanceDemoList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "DemoId";
            this.Master.DefaultSortExpression = "DemoId DESC"; //也可不赋值

            SKT.Common.Model.SearchSettings searchSettings = new SKT.Common.Model.SearchSettings();
            searchSettings.AddCondition("DemoCode",txtMaintenanceDemoNO.Text);
            searchSettings.AddCondition("DemoName",txtMaintenanceDemoName.Text);
