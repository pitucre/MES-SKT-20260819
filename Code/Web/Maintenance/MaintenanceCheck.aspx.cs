...
{
    public partial class MaintenanceCheck : BasePage
    {
        ...
        private MaintenancePlanInfo PageData
        {
            set
            {
                ...
                //lblObjectName.Text = value.PlanObjectTypeName;
                //if (value.PlanObjectType == 1)
                //{
                //    this.trEquimentType.Visible = false;

                //}
                //else
                //{
                //    this.trEquiment.Visible = false;
                //}
                lblEquipmentCode.Text = value.EquipmentCode.ToString();
                lblEquipmentName.Text = value.EquipmentName.ToString();

                //lblEquimentTypeName.Text = value.EquipmentTypeName;
                ...
                //lblMaintainContents.Text = value.MaintainContents.ToString();
