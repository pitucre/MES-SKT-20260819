...
{
    public partial class SerialNumberEdit : BasePage
    {
        ...
        protected SKT.LeanMES.SerialNumber.Model.SerialNumberInfo NextNumber
        {
            set
            {
                ...
                if (ddlNumberType.Items.FindByValue(value.Next_Number_Type) != null)
                {
                    this.ddlNumberType.SelectedValue = value.Next_Number_Type;
                    if (NextID > 0)
                    {
                        this.ddlNumberType.Enabled = false;
                    }
                    //if (this.ddlNumberType.SelectedValue == "-26")
                    //{
                    //    this.ddlReset.Enabled = false;
                    //}
                }
            }
        }
        ...
        protected void ddlNumberType_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //{
            //    this.ddlReset.Enabled = false;
            //    this.ddlReset.SelectedValue = "1";
            //}
            //else
            //{
            //    this.ddlReset.Enabled = true;
            //}
