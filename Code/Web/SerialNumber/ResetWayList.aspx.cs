...
{
    public partial class ResetWayList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "ResetWayId";
            this.Master.DefaultSortExpression = "ResetWayId DESC"; //也可不赋值

            SKT.Common.Model.SearchSettings searchSettings = new SKT.Common.Model.SearchSettings();
            searchSettings.AddCondition("ResetWay", this.txtResetWay.Text.Trim());
            searchSettings.ExtensionCondition = "IsSystemResetWay = 0";
            ...
            if (IsPostBack)
            {
                if (Request.Form["hdnOperate"].ToLower() == "delete")
                {
                    ...
                    try
                    {
                        SKT.LeanMES.SerialNumber.BLL.ResetWay bll = new SKT.LeanMES.SerialNumber.BLL.ResetWay();
