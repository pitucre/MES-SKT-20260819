<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/EditMaster.master"  CodeBehind="SerialNumberCopy.aspx.cs" Inherits="SKT.LeanMES.Web.SerialNumber.SerialNumberCopy" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="EditContent" runat="Server" EnableViewState="true">
    <table width="100%" class="EditeContentTable">
        <tr>
            ...
            <td class="Field2" colspan="3">
                <asp:DropDownList ID="ddlNumberType" runat="server" IsRequired="1">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
            ...
            <td class="Field2">
                <asp:TextBox ID="txtValue" runat="server" CssClass="TextBox" Text="*" Enabled="true"
        ...
        <tr>
            ...
            <td class="Field2" colspan="3">
                <asp:TextBox ID="txtPrefix" runat="server" Width="85%" CssClass="TextBox" ></asp:TextBox><input
        ...
        <tr>
            ...
            <td class="Field2" colspan="3">
                <asp:TextBox ID="txtSuffix" runat="server" Width="85%" CssClass="TextBox" ></asp:TextBox><input
                    type="button" id="btnSuffix" class="ButtonBox" value="..." title="" onclick="selectSFormat();" />
            </td>
        </tr>
        <tr>
            <td class="Label2">
                <%= Resources.lang.SequenceBase %><em>*</em>
            </td>
            <td class="Field2">
                <asp:TextBox ID="txtBase" runat="server" IsRequired="1" Text="10" CssClass="TextBox"></asp:TextBox>
            </td>
            <td class="Label2">
                <%= Resources.lang.NumericalSystemList %>
            </td>
            <td class="Field2">
                <asp:TextBox ID="txtNumberSeq" runat="server" Width="83%" CssClass="TextBox" Style="text-transform: uppercase"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="Field2">
                <asp:TextBox ID="txtLength" runat="server" IsRequired="1"  CssClass="TextBox"></asp:TextBox>
            </td>
            <td class="Label2">
                <%= Resources.lang.MaxSeq %><em>*</em>
            </td>
            <td class="Field2">
                <asp:TextBox ID="txtMax" runat="server" IsRequired="1" CssClass="TextBox" Style="text-transform: uppercase"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="Label2">
            ...
            <td class="Field2">
                <asp:TextBox ID="txtMin" runat="server" IsRequired="1" CssClass="TextBox" Text="1" Style="text-transform: uppercase"></asp:TextBox>
            </td>
            <td class="Label2">
                <%= Resources.lang.IncrementBy %>
            </td>
            <td class="Field2">
                <asp:TextBox ID="txtIncrement" runat="server" CssClass="TextBox" Text="1" Style="text-transform: uppercase"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="Label2">
            ...
            <td class="Field2">
                <asp:TextBox ID="txtCurrent" runat="server" IsRequired="1" CssClass="TextBox"></asp:TextBox>
            </td>
            <td class="Label2">
        ...
        <tr>
            ...
            <td class="Field2" colspan="3">
                <asp:TextBox ID="txtDesc" runat="server" CssClass="TextBox" TextMode="MultiLine" Width="420" Height="60"></asp:TextBox>
            </td>
        </tr>
        <%--<tr>
            <td class="Label2">
    ...
    <script type="text/javascript">
        ...
        function Save() { 
            ...
            entity.Prefix = $("#<%=this.txtPrefix.ClientID %>").val();
            entity.Suffix = $("#<%=this.txtSuffix.ClientID %>").val();
        ...
        {
           chooseItem=4;           
           dialog({ title: "<%=Resources.Common.ChooseWindow %>", src: "<%=SKT.LeanMES.Web.WebHelper.WebRoot %>/Framework/ChoosePage.aspx?PageId=3&SearchCondition=" + SearchCondition + "&Multiple=false&rnd=" + Math.random(), width: 650, height: 350 });
        } 
        ...
        function getChooseValue(list) {
            if (chooseItem == 1) {
                $("#<%=this.txtValue.ClientID %>").val(list[0][2]);
                ...
                var preFix=$("#<%=this.txtPrefix.ClientID %>").val();
                $("#<%=this.txtPrefix.ClientID %>").val(preFix+list[0][1]);
            }
            else if (chooseItem == 5) {
                var sufFix=$("#<%=this.txtSuffix.ClientID %>").val();
