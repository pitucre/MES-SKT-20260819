...
{
    public partial class SerialNumberTypeList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "SerialNumberTypeId";
            this.Master.DefaultSortExpression = "SerialNumberTypeId DESC"; //也可不赋值

            SKT.Common.Model.SearchSettings searchSettings = new SKT.Common.Model.SearchSettings();
            searchSettings.AddCondition("SerialNumberType", this.txtSerialNumberType.Text.Trim().Replace("'","''"));
            ...
            if (IsPostBack)
            {
                if (Request.Form["hdnOperate"].ToLower() == "delete")
                {
                    ...
                    try
                    {
                        SKT.LeanMES.SerialNumber.BLL.SerialNumberType bll = new SKT.LeanMES.SerialNumber.BLL.SerialNumberType();
