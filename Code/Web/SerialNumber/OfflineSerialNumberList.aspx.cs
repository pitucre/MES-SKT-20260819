...
{
    public partial class OfflineSerialNumberList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "OfflineSNConfigId";
            this.Master.DefaultSortExpression = "OfflineSNConfigId DESC"; //也可不赋值

            SKT.Common.Model.SearchSettings searchSettings = new SKT.Common.Model.SearchSettings();
            searchSettings.AddCondition("MainItemCode", this.txtMainItemCode.Text.Trim());
            searchSettings.AddCondition("PartItemCode", this.txtPartItemCode.Text.Trim());
            ...
            if (IsPostBack)
            {
                ...
                {
                    SKT.LeanMES.SerialNumber.BLL.OfflineSNConfig bll = new SKT.LeanMES.SerialNumber.BLL.OfflineSNConfig();
