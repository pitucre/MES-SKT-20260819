...
{
    public partial class FloorInfoList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "Fid";
            this.Master.DefaultSortExpression = "Fid DESC"; //也可不赋值

            SKT.Common.Model.SearchSettings searchSettings = new SKT.Common.Model.SearchSettings();
            searchSettings.AddCondition("Name", txtFloorInfoNO2.Text);
            ...
            if (IsPostBack)
            {
                ...
                {
                    SKT.LeanMES.Container.BLL.FloorInfo bll = new LeanMES.Container.BLL.FloorInfo();
