...
{
    public partial class PackagingAttachmentOrderList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "PAOId";
            this.Master.DefaultSortExpression = "PAOId DESC"; //也可不赋值
            ...
            if (IsPostBack)
            {
                ...
                {
                    SKT.LeanMES.Container.BLL.PackagingAttachmentOrder bll = new SKT.LeanMES.Container.BLL.PackagingAttachmentOrder();
