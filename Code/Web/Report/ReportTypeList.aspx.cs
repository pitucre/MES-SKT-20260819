...
{
    public partial class ReportTypeList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string keyWords = this.txtReportTypeName.Text.Trim();
            ...
            if (this.IsPostBack)
            {
                ...
                if (operation.ToLower() == "delete")
                {
                    ...
                    try
                    {
                        ...
                        bll.DeleteReportType(Request.Form["hdnIdString"].ToString(), userName);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                //3改为columnIndex_ModifyBy
                //4改为columnIndex_ModifyDateTime
