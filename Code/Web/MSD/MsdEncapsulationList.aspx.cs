...
{
    public partial class MsdEncapsulationList : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var encapStatus = this.selEncapStatus.SelectedValue;
            if (encapStatus != "")
            {
                searchSettings.AddCondition("EncapStatus", encapStatus);
            }
