...
{
    public partial class MsdBakeContionList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "Bid";
            this.Master.DefaultSortExpression = "ModifyDateTime DESC";

            SKT.Common.Model.SearchSettings searchSettings = new SKT.Common.Model.SearchSettings();

            searchSettings.AddCondition("MSL", this.txtContainerCode.Text.Trim().Replace("'", "''"));
            ...
            if (IsPostBack)
            {
                ...
                {
                    SKT.LeanMES.MSD.BLL.MsdBakeContion bll = new SKT.LeanMES.MSD.BLL.MsdBakeContion();
                    try
                    {
