<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EditMaster.master" AutoEventWireup="true"
    CodeBehind="InspectionTypeEdit.aspx.cs" Inherits="SKT.LeanMES.Web.Quality.InspectionTypeEdit" %>
...
<div class="infoTips">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Save() {
            ...
            var ajax = SKT.LeanMES.Web.AjaxServices.AjaxQuality.InspectionTypeEdit(JSON.stringify(entity));
            if (ajax.error != null) {
