<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/EditMaster.master" CodeBehind="InspectionOrderGroupAffirm.aspx.cs" Inherits="SKT.LeanMES.Web.Quality.InspectionOrderGroupAffirm" %>
<asp:Content ID="Content1" ContentPlaceHolderID="EditContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Save() {
            ...
            var ajax = SKT.LeanMES.Web.AjaxServices.AjaxQuality.InspectionOrderSaveGroupAffirm(parseInt(Id), res, Rem, parseInt(userId));
            if (ajax.error != null) {
