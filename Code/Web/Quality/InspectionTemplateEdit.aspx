<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EditMaster.master" AutoEventWireup="true"
    CodeBehind="InspectionTemplateEdit.aspx.cs" Inherits="SKT.LeanMES.Web.Quality.InspectionTemplateEdit" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="EditContent" runat="server">
        ...
        <tr>
            ...
            <td class="Field3">
                ...
                <div id="file" style="display: inline">
                    <a id="fileshow">查看</a>
                    <a id="delfile" onclick="delfile()">删除</a>
                </div>
            </td>
        </tr>
    </table>
    ...
    <script language="javascript" type="text/javascript">
        ...
        var index = 1;
        var inspecType = -1;
        var filename = $("#<%=this.hdnFile.ClientID%>").val();
        if (filename == "") {
            $("#file").hide();
        } else {
            $("#file").show();
        ...
        function delfile() {
            var ajax = SKT.LeanMES.Web.AjaxServices.AjaxQuality.DeleteFAIInspectionTemplateFile(Id);
            if (ajax.error != null) {
        ...
        layui.use('upload', function () {
            ...
            upload.render({
                elem: '#upload-image',
                url: '<%=SKT.LeanMES.Web.WebHelper.WebRoot %>/Handler/UploadHander.ashx?Action=FAIInspectionTemplate',
                data: { InspectionTemplateId: Id, userName: userName },
                exts: 'pdf', //只允许上传文件类型
                ...
                //done
                    ...
                    //上传成功
                    filename = res.EsopFileName;
                    $("#file").show();
                    alert("上传成功!");

                },
                before: function (obj) {
                    this.data.InspectionTemplateId = Id;
        ...
        function addDetail(entity, i) {
            ...
            row.className = "ListTableOddRow tr-item";
            row.setAttribute("tr-idx", i);
        ...
        var GetValue = function (data, Id, StandardUnit, OffsetUnit) {
            ...
            $("#tblExpand tr[tr-idx=\"" + Id + "\"]").find("td input.InspectionAccording").val(data);
            $("#tblExpand tr[tr-idx=\"" + Id + "\"]").find("td input.txtUnit").val(StandardUnit);
            $("#tblExpand tr[tr-idx=\"" + Id + "\"]").find("td input[name='txtOffsetUnit']").val(OffsetUnit);
        }
