<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Masters.master" AutoEventWireup="true" CodeBehind="InspectionItemListTree.aspx.cs" Inherits="SKT.LeanMES.Web.Quality.InspectionItemListTree" %>
    ...
    <script type="text/javascript">
        ...
        function Add() {
            ...
            var openWinUrl = "<%=SKT.LeanMES.Web.WebHelper.WebRoot %>"
             + "/Quality/InspectionItemEdit.aspx?name=QC_InspectionItemAdd&ID=-1&parentId=" + parentId + "&parentName=" + parentName;
        ...
        function Edit() {
            ...
            actionFalg = 2;
            var openWinUrl = "<%=SKT.LeanMES.Web.WebHelper.WebRoot %>" + "/Quality/InspectionItemEdit.aspx?name=QC_InspectionItemEdit&ID=" + parentId + "&controld=selectValue";
            dialog({ title: "<%=Resources.Pages.QC_InspectionItemEdit %>", src: openWinUrl, width: 600, height: 400 });
        ...
        function Delete() {
            ...
            var ajax = SKT.LeanMES.Web.AjaxServices.AjaxQualityInspection.GetInspectionItemDelete(node.id);
            if (ajax.error != null) {
