<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EditMaster.master" AutoEventWireup="true" CodeBehind="AQLPlanEdit.aspx.cs" Inherits="SKT.LeanMES.Web.Quality.AQLPlanEdit" %>
...
<table class="EditeContentTable" width="100%">
        ...
        <script language="javascript" type="text/javascript">
            ...
            function Onkey() {
                ...
                $("#<%=this.txtSamplePer.ClientID %>").val(percentage);
            ...
            function Save() {
                ...
                var txtLotSize = $("#<%=this.txtLotSize.ClientID %>").val();
                var txtSamplePer = $("#<%=this.txtSamplePer.ClientID %>").val();
                var txtSampleSize = $("#<%=this.txtSampleSize.ClientID %>").val();
                ...
                var ajax = SKT.LeanMES.Web.AjaxServices.AjaxServicesOBAAudit.EditOBAItemAudit(entity);
                if (ajax.error != null) {
