...
{
    public partial class AQLSampleList : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Master.RecordIDField = "AQLSampleId";
            Master.DefaultSortExpression = "AQLSampleName";
            ...
            if (IsPostBack)
            {
                ...
                if (hasSearchSettings)
                {
                    ...
                    searchSettings.AddCondition("AQLSampleName", txtAqlName.Text.Trim());
