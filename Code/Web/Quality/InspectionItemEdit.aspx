<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EditMaster.master" AutoEventWireup="true" CodeBehind="InspectionItemEdit.aspx.cs" Inherits="SKT.LeanMES.Web.Quality.InspectionItemEdit" %>
...
<%--                    <asp:ListItem Value="3">常规范围</asp:ListItem>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function selectMethods() {
            ...
            dialog({ title: "<%=Resources.Common.ChooseWindow %>", src: "<%=SKT.LeanMES.Web.WebHelper.WebRoot %>/Framework/ChoosePage.aspx?PageId=822&PageCondition=" + searchCondition + "&Multiple=false&rnd=" + Math.random(), width: 600, height: 350 });
        }
        ...
        function getChooseValue(list) {
            if (chooseFlag == 6) {;
                ...
                $("#<%=txtInpsectionmethods.ClientID %>").val(list[0][1]);
            }
            chooseFlag = -1;
        }
        ...
        function Save() {
            ...
            var ajax = SKT.LeanMES.Web.AjaxServices.AjaxQuality.InspectionItemEdit(entity);
            if (ajax.error != null) {
