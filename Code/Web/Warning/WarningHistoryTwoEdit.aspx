<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EditMaster.master" AutoEventWireup="true" CodeBehind="WarningHistoryTwoEdit.aspx.cs" Inherits="SKT.LeanMES.Web.Warning.WarningHistoryTwoEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="EditContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Save() {
            ...
            var txtTowSolve = $.trim($("#<%=this.txtSolution.ClientID%>").val());
            ...
            var ajax = SKT.LeanMES.Web.AjaxServices.AjaxWarning.SaveTwoSolve(warninghistoryId, txtTowSolve);
            if (ajax.error != null) {
