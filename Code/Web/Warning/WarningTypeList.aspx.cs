...
{
    public partial class WarningTypeList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "WarningTypeId";
            this.Master.DefaultSortExpression = "WarningTypeId DESC"; //也可不赋值

            SKT.Common.Model.SearchSettings searchSettings = new SKT.Common.Model.SearchSettings();
            searchSettings.AddCondition("WarningTypeName", this.txtWarningTypeName.Text.Trim());
            ...
            if (IsPostBack)
            {
                if (Request.Form["hdnOperate"].ToLower() == "delete")
                {
                    try
                    {
                        SKT.LeanMES.Warning.BLL.WarningType bll = new SKT.LeanMES.Warning.BLL.WarningType();
