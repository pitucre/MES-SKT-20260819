<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EditMaster.master" AutoEventWireup="true" CodeBehind="WarningHistoryThreeEdit.aspx.cs" Inherits="SKT.LeanMES.Web.Warning.WarningHistoryThreeEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="EditContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Save() {
            ...
            var txtThreeSolve = $.trim($("#<%=this.txtSolution.ClientID%>").val());
            ...
            var ajax = SKT.LeanMES.Web.AjaxServices.AjaxWarning.SaveThreeSolve(warninghistoryId, txtThreeSolve);
            if (ajax.error != null) {
