<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierDeliveryKanban.aspx.cs" Inherits="SKT.LeanMES.Web.Kanban.Builtin.SupplierDeliveryKanban" %>
    ...
    <form id="form1" runat="server">
        <div style="width: 100%; height: 100%;">
            <ul style="height: 10%;">
                <li style="height: 100%;">
                    ...
                    <div class="table" style="float: left; width: 57%;">
                        <span class="cell" style="font-size: 36px; color: #FFFFFf; text-shadow: 3px 2px 8px #5a5af7; font-weight: bold;">仓库收料看板</span>
                    </div>
            ...
            <ul style="height: 42%; border-top: 1px solid #008b8b; border-bottom: 5px solid #000000; border-top: 5px solid #000000;">
                <li style="height: 42%;">
                    <table style="width: 100%;">
                        <tr class="rows">
                            <th style="width: 3%" class="thTitle">序号</th>
                            <th style="width: 10%" class="thTitle">单据编号</th>
                            <th style="width: 12%" class="thTitle">物料编码</th>
                            <th style="width: 16%" class="thTitle">物料名称</th>
                            <th style="width: 12%" class="thTitle">物料规格</th>
                            <th style="width: 8%" class="thTitle">收货数量</th>
                            <th style="width: 8%" class="thTitle">单据状态</th>
                            <th style="width: 9%" class="thTitle">检验结果</th>
                            <th class="thTitle">供应商</th>
                            <th style="width: 8%" class="thTitle">紧急程度</th>
                        </tr>
                    </table>
            ...
            <ul style="height: 38%;">
                <li style="height: 99%; margin-top: 10px;">
                    <div style="height: 100%; width: 20%; float: left; border-right: 5px solid #000000;" id="echarts_gauge3">
                        ...
                        <table style="height: 90%; width: 100%">
                            <tr style="border-bottom: 5px solid #000000;">
                                <td class="tdFont">当天收货数量</td>
                                <td class="tdFont1">
                                    <label id="lblPlanQty">0</label></td>
                            </tr>
                            <tr style="border-bottom: 5px solid #000000;">
                                <td class="tdFont">当天收货批次</td>
                                <td class="tdFont1">
                                    <label id="lblItemCount">0</label></td>
                            </tr>
                            <tr>
                                <td class="tdFont">当天入库数量</td>
                                <td class="tdFont1">
                                    <label id="lblActualQtyTotal">0</label></td>
                            </tr>
                            <tr>
                                <td class="tdFont">当天入库批次</td>
                                <td class="tdFont1">
                    ...
                    <div style="height: 100%; width: 79%; float: left;" class="gauge" id="echarts_gauge1"></div>
        ...
        <script type="text/javascript">
            ...
            function GetInfo() {
                $.ajax({
                    type: 'POST',
                    url: '<%=SKT.LeanMES.Web.WebHelper.WebRoot %>/Handler/SupplierDeliveryKanbans.ashx',
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(data, function (i, n) {
                            ...
                            if (n["UrgentLevel"] == "一般") {
                                html += '<tr class="rows" >' +
                                    '<td style="width: 3%" class="thTitle1">' + n["RowId"] + '</td>' +
                                    '<td style="width: 10%" class="thTitle1">' + n["InspectionNo"] + '</td>' +
                                    '<td style="width: 12%" class="thTitle1">' + n["ItemCode"] + '</td>' +
                                    '<td style="width: 16%" class="thTitle1" title="' + n["ItemName"] +'" >' + RetrunStr(n["ItemName"]) + '</td>' +
                                    '<td style="width: 12%" class="thTitle1" title="' + n["ItemSpec"] + '">' + RetrunStr(n["ItemSpec"]) + '</td>' +
                                    '<td style="width: 8%" class="thTitle1">' + formatNumber(n["InspectionQty"]) + '</td>' +
                                    '<td style="width: 8%" class="thTitle1">' + n["StatusDesc"] + '</td>' +
                                    '<td style="width: 9%" class="thTitle1">' + n["CheckResult"] + '</td>' +
                                    '<td style="" class="thTitle1">' + n["VendorName"] + '</td>' +
                                    '<td style="width: 8%" class="thTitle1">' + n["UrgentLevel"] + '</td>' +
                                    '</tr>';
                            }
                            else {
                                html += '<tr class="rows" >' +
                                    '<td style="width: 3%" class="thTitle2">' + n["RowId"] + '</td>' +
                                    '<td style="width: 10%" class="thTitle2">' + n["InspectionNo"] + '</td>' +

                                    '<td style="width: 12%" class="thTitle2">' + n["ItemCode"] + '</td>' +
                                    '<td style="width: 16%" class="thTitle2" title="' + n["ItemName"] + '" >' + RetrunStr(n["ItemName"]) + '</td>' +
                                    '<td style="width: 12%" class="thTitle2" title="' + n["ItemSpec"] + '">' + RetrunStr(n["ItemSpec"]) + '</td>' +
                                    '<td style="width: 8%" class="thTitle2">' + formatNumber(n["InspectionQty"]) + '</td>' +
                                    '<td style="width: 8%" class="thTitle2">' + n["StatusDesc"] + '</td>' +
                                    '<td style="width: 9%" class="thTitle2">' + n["CheckResult"] + '</td>' +

                                    '<td style="" class="thTitle2">' + n["VendorName"] + '</td>' +
                                    '<td style="width: 8%;background-color: yellow; color: red;" class="thTitle1" >' + n["UrgentLevel"] + '</td>' +
                                    '</tr>';
                            }
                        })
