<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JITMaterialDistribution.aspx.cs" Inherits="SKT.LeanMES.Web.Kanban.Builtin.JITMaterialDistribution" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        #data_tbody td, #data_tfoot td { text-align: center; font-size: 20px; color: #38FFFF; /*width: 7%;*/ border-top: 1px solid #263C54; /*border-left: 1px solid #c5c5c5;*/ border-bottom: 1px solid #263C54; }
    ...
    <form id="form1" runat="server">
            ...
            <ul style="height: 10%;" class="head">
                <li style="height: 100%;">
                    ...
                    <div class="table" style="float: left; width: 57%;">
                        <span class="cell" style="font-size: 36px; color: #FFFFFf; text-shadow: 3px 2px 8px #5a5af7; font-weight: bold;">JIT 物料配送看板</span>
                    </div>
            ...
            <ul style="height: 80%; border-top: 1px solid #008b8b; border-bottom: 5px solid #000000; border-top: 5px solid #000000;" class="content">
                <li style="height: 80%;">
                    <table id="data_thead" style="height: 12%; border-left: 1px solid #263C54; font-size: 21px; border-right: 1px solid #263C54; width: 98%; margin: 0 auto;">
                       <thead>
                         <tr class="rows">
                            <th style="width: 20%" class="thTitle">生产排程工单号</th>
                            <th style="width: 18%" class="thTitle">产线</th>
                            <th style="width: 18%" class="thTitle">仓库备料可用时间</th>
                            <th style="width: 18%" class="thTitle">产线物料可用时间</th>
                            <th style="width: 18%" class="thTitle">是否需要配送</th>
        ...
        <script type="text/javascript">
            ...
            function bulidDataTb() {
                ...
                var data = null;
                var data1 = null;
                var ajax = SKT.AjaxCommon.DBService.ExecuteSpc("uspKanBanStockListMaterial", JSON.stringify(entity));
                if (ajax.error != null) {
                ...
                var normalHtml = "";
                //var ajax1 = SKT.AjaxCommon.DBService.ExecuteSpc("uspKanBanStockListPrepareMaterial", JSON.stringify(entity));
                //if (ajax1.error != null) {
                //    // confirmDialog(ajax.error.Message);
                //    return false;
                //}
                ...
                //    if(n.工单状态=="待备料")
                //    {
                //        P_Orders.push(n.生产排程工单号);
                //    }
                //});
         
                $.each(data, function (i, n) {
                
                   // if (P_Orders.indexOf(n.生产排程工单号) == -1) {



                        normalHtml += "<tr class=\"rows\" >" +

                                "<td style=\"width:20%\">" + n.生产排程工单号 + "</td>" +
                                "<td style=\"width:18%\">" + n.产线 + "</td>" +
                                "<td style=\"width:18%\">" + (n.仓库备料可用时间*60) + " 分钟</td>" +
                                "<td style=\"width:18%\">" + (n.产线物料可用时间 * 60) + " 分钟</td>" +
                                "<td style=\"width:18%; \ " + (n.是否配送 == "是" ? "color:red" : "") + " \">" + n.是否配送 + "</td>" +
                                "</tr>";
                  //  }
