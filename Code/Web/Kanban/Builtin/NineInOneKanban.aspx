<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NineInOneKanban.aspx.cs" Inherits="SKT.LeanMES.Web.Kanban.Builtin.NineInOneKanban" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .dvSub { font-family: SimSun;font-size: 22px; color: #F1F1F2; font-weight: bold;position:relative;border-radius:30px;}
         .divTitle { text-align:center; width:98.4%;height:22px; padding:5px; background-color:#215181;border-top-left-radius:30px;border-top-right-radius:30px;border-bottom-right-radius:0px;border-bottom-left-radius:0px;}

        ul, li { margin: 0px; padding: 0px; list-style: none; text-align: center; /*border: 1px solid #38FFFF;*/ }
        * { margin:0px; padding:0%;}
        .dvMain { width:100%;height:95%;}
        ...
        .Head_li {margin: 0px; padding: 0px; list-style: none; text-align: center; display: inline; float:left; width:33%; height:38px;}
        .E2_li {margin: 0px; padding: 0px; list-style: none; text-align: center; display: inline; float:left; width:33%;}
        .E2_div { margin-top:10px;}
        #E2_1 { width:98%; height:100px; background-color:#00192a;}
        #E2_2 { width:98%; height:130px; background-color:#00192a;}
        #E2_3 { width:98%; height:130px; background-color:#00192a;}
        .E2_FontColor { color:#0168ff;font-size:18px;font-weight: bold;}
        .E2_FontColor1 { color:#F1F1F2;font-size:18px;font-weight: bold;}
...
<body>
    <form id="form1" runat="server">
        <div style="text-align:center; background-color:#0b3034; height:44px;position:relative;">
            <ul>
               <li class="Head_li"><span class="logo_cusH1 cellH" style="margin-left: 15px; width: 260px; display: block; float: left;"></span></li>
               <li class="Head_li"><span class="fontfamily" style="font-size:30px; color:#0066ff;font-weight: bold;">工业4.0车间监控中心</span></li>
               <li class="Head_li"><span class="logo_cusH2 cellH" style="margin-left: 15px; width: 180px; display: block; float: right;"></span></li>
            </ul>
            <div class="divClassTimer">
                <span class="cell" style="font-size: 10px; color: #e5e606; font-weight: bold;" id="dateAndWeek_E2"></span>
            </div>
        </div>
        
        <div class="dvMain">
            <div class="dvSub" style="margin-right:2px;">
                <div class="divTitle"><span class="cell">电机车间布局图</span></div>
                <div id="NIOecharts1" style="background-image: url(../../Content/images/XSS-WorkShop.png);background-size:100% 96%; width:100%;height:95%;"></div>                
            </div>            
            <div class="dvSub" id="NIOecharts2" style="margin-right:2px;">
                <div class="divTitle">
                    <ul>
                         <li class="E2_li"><span class="cell" style="margin-left: 15px; width: 260px; display: block; float: left; color:#215181;">_</span></li>
                         <li class="E2_li"><span class="cell" >电机车间生产监控</span></li>
                        <%-- <li class="E2_li" style="text-align:right; padding-top:30px;"><span class="cell" style="font-size: 15px; color: #e5e606; font-weight: bold;" id="dateAndWeek_E2"></span></li>--%>
                         <li class="E2_li" style="text-align:right; padding-top:30px;"><span class="cell" style="color:#215181;"></span></li>
                    </ul>
                </div>
                <div style="text-align:center; height:60%; margin-top:10px;  padding-top:20px;">
                    <ul>
                        <li class="E2_li"><span class="E2_FontColor">当日电机产出数</span><br /><div class="E2_div" id="E2_1" style="font-size:50px; padding-top:30px; color:#a0d500"></div></li>
                        <li class="E2_li"><span  class="E2_FontColor">完成率</span><br /><div class="E2_div gauge" id="E2_2"></div></li>
                        <li class="E2_li"><span  class="E2_FontColor">齐套率</span><br /><div class="E2_div gauge" id="E2_3"></div></li>
                    </ul>
                </div>
            ...
            <div class="dvSub" style="margin-right:2px; margin-top:2px;">
                <div class="divClass">
                    <table style="width:100%;">
                        <tr>
                            <td style="text-align:left;">达成率</td>
			   <td style="text-align:center;">产出</td>
            ...
            <div class="dvSub" id="NIOecharts5" style="margin-right:2px;margin-top:2px;">
                <div style="width: 100%; height: 100%;">
                    <div class="divTitle"><span class="cell">计划日看板</span></div>                    
                    <ul style="height: 70%; " class="content" id="E5_ul">
                        <li style="height: 80%;">
                            ...
                            <div id="_layout_left_data_div_tbody_JIT">
                                <div id="_layout_left_data_div2_tbody_JIT">
                                    <table id="data_tbody_JIT" style="width: 98%;font-size: 10px; color: #4EC9CE;margin: 0 auto;">
                                        <tbody>
                                        </tbody>
                                    </table>
                                </div>
                    ...
                    <ul style="height: 10%;" class="bot">
                        <li style="height: 100%;">
                            <div id="_left_top_welcome_text" style=" padding-top:20px; padding-bottom:5px;font-size: 16px; color: red; font-weight: bold; text-align:center; display:block;">
            ...
            <div class="dvSub" style="margin-top:2px;">
                <div class="divTitleEchart">
                </div>
                <div id="NIOecharts6" style="width:100%;height:100%;"></div>
            </div>

            <div class="dvSub" id="NIOecharts7" style="margin-right:2px;margin-top:2px;">
                <div class="divTitle"><span class="cell">车间品质监控看板</span></div>                 
               <%-- <ul style="height: 35%; border-top: 1px solid #008b8b; border-bottom: 5px solid #000000; border-top: 5px solid #000000;" id="E7_ul">
                    <li style="height: 35%;">
                ...
                <ul style="height: 100%;">
                    <li style="height: 100%;">
                        <div style="height: 90%; width: 49%; float: left; border-right: 2px solid #000000;" class="gauge" id="echarts_gauge1"></div>
                ...
                $.ajax({
                    ...
                    success: function (resultData) {
                        ...
                        $.each(resultData, function (i, item) {
                            ...
                            if (item.Line1_Rate == 0) {
                                yLine2.push(item.Line1_Rate);
                            }
                            yLine3.push(item.Line2_Rate);
                            if (item.Line2_Rate == 0) {
                                yLine4.push(item.Line2_Rate);
                            }
                        ...
                        var option = {
                            ...
                            yAxis: {
                                ...
                                axisLabel: {
                                    ...
                                    //    function (p) {
                                    //    var colorList = [];
                                    //    var c1 = '#00ff00';  //绿色，运行中
                                    //    var c2 = '#fcc423';  //黄色，暂停中
                                    //    var c3 = '#ff0000';  //红色，停止中
                                    //    $.each(resultData, function (i, item) {
                                    //        if (item.Line_Name == p) {
                                    //            if (item.Line_Status == 3) {
                                    //                colorList.push(c3);
                            ...
                            series: [
                                {
                                    ...
                                    itemStyle: {
                                        normal: {
                                            ...
                                            color: function (p) {
                                                ...
                                                //var c3 = '#ff0000';  //红色，停止中
                                                //$.each(resultData, function (i, item) {
                                                //    if (item.Line_Name == p.name && item.Line_Status == 3) {
                                                //        colorList.push(c3);
                                                //    }
                                                //   else if (item.Line_Name == p.name && item.Line_Status == 2) {
                                                //        colorList.push(c2);
                                                //    }
                                                //   else{
                                                //        colorList.push(c1);
                                                ...
                                                var colorList = [];
                                                //版本二
                                                //var c1 = '#18f9fa';//自动绕线A线
                                                //var c2 = '#12c1f2';//自动绕线B线
                                                //var c3 = '#8eeeaa';//自动绕线C线
                                                //var c4 = '#83e49e';//手动绕线A线
                                                //var c5 = '#10bff1';//自动装配A线
                                                //var c6 = '#11f6f9';//自动装配B线
                                                //var c7 = '#10c1f4';//自动装配C线
                                                //var c8 = '#12c0f2';//手动装配B线
                                                //版本三  update by feifeng.zhao 2023.05.22   每条线进度条达成率部份的全部用绿色表示
                                    ...
                                    zlevel: 2//柱状图所有图形的 zlevel 值,层级高的的显示在最上面 color: ['#00ff00', '#fcc423', '#ff0000'],
                                },
                                {
                                    name: '暂停中',  //右侧显示数据  color: ['#00ff00', '#fcc423', '#ff0000'],
                                    type: 'bar',
        ...
        <script type="text/javascript">
            ...
            */
            ...
            function init_srolltext_JIT() {
                ...
                scrollIntervalId_JIT = setInterval('scrollUp_JIT()', 50);
            }
        ...
        <script type="text/javascript">
            ...
            */
            ...
            $(document).ready(function () {
                ...
                //ResizeAll();  //update by feifeng.zhao 2023.05.18 客户说去除此图表
                bulidDataTb();
                bulidNCCharts();
                bulidNCByWeek();  //update by feifeng.zhao 2023.05.16 客户说去除此图表
                bulidNCByRate();  //update by feifeng.zhao 2023.05.08 客户说去除此图表
                GetNowTime();
            ...
            function getServerTime(flag) {
                ...
                $.ajax({
                    ...
                    data: { "api": "GetServerTime", "fmt": "0" },  //要农历日期
                    dataType: 'text',
            ...
            function ResizeAll() {
                ...
                if ($(".rows").length * _contentHeight * 0.4 > _contentHeight) {
                    ...
                    //$("#_layout_left_data_div_tbody").height(80);
                    //$("#_layout_left_data_div_tbody").css("height","100%");
