<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JITMaterialPreparation.aspx.cs" Inherits="SKT.LeanMES.Web.Kanban.Builtin.JITMaterialPreparation" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        #data_tbody td, #data_tfoot td { text-align: center; font-size: 18px; color: #38FFFF; /*width: 7%;*/ border-top: 1px solid #263C54; /*border-left: 1px solid #c5c5c5;*/ border-bottom: 1px solid #263C54; }
            ...
            <ul style="height: 10%;" class="head">
                <li style="height: 100%;">
                    ...
                    <div class="table" style="float: left; width: 57%;">
                        <span class="cell" style="font-size: 36px; color: #FFFFFf; text-shadow: 3px 2px 8px #5a5af7; font-weight: bold;">JIT 物料备料看板</span>
                    </div>
            ...
            <ul style="height: 80%; border-top: 1px solid #008b8b; border-bottom: 5px solid #000000; border-top: 5px solid #000000;" class="content">
                <li style="height: 80%;">
                    <table id="data_thead" style="height: 12%; border-left: 1px solid #263C54; font-size: 21px; border-right: 1px solid #263C54; width: 98%; margin: 0 auto;">
                       <thead>
                         <tr class="rows">
                            <th style="width: 15%" class="thTitle">生产排程工单号</th>
                            ...
                            <th style="width: 6%" class="thTitle">工单数量</th>
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (i < 5)
                    {
                        ...
                        normalHtml += "<tr class=\"rows\" >" +
                                                 "<td style=\"width:15%\">" + data[i].生产排程工单号 + "</td>" +
                                                 "<td style=\"width:19%\">" + data[i].领料单号 + "</td>" +
                                                 "<td style=\"width:14%\">" + data[i].产品编码 + "</td>" +
                                                 "<td style=\"width:14%\">" + data[i].产品名称 + "</td>" +
                                                 "<td style=\"width:14%\">" + data[i].产线 + "</td>" +
                                                 "<td style=\"width:6%\">" + data[i].工单数量 + "</td>" +
                                                 "<td style=\"width:6%\">" + data[i].工单状态 + "</td>" +
                                                 "<td style=\"width:6%\">" + data[i].已备料站 + "</td>" +
                                                 "<td style=\"width:6%\">" + data[i].待备料站 + "</td>" +
                                                 "</tr>";
