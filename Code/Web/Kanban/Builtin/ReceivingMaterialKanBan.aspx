 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceivingMaterialKanBan.aspx.cs" Inherits="SKT.LeanMES.Web.Kanban.Builtin.ReceivingMaterialKanBan" %>
            ...
            <ul style="height: 10%;" class="head">
                <li style="height: 100%;">
                    ...
                    <div class="table" style="float: left; width: 57%;">
                        <span class="cell" style="font-size: 36px; color: #FFFFFf; text-shadow: 3px 2px 8px #5a5af7; font-weight: bold;">SMT接料看板</span>
                    </div>
                    ...
                    <table id="data_thead" style="height: 12%; border-left: 1px solid #263C54; font-size: 21px; border-right: 1px solid #263C54; width: 98%; margin: 0 auto;">
                       <thead>
                         <tr class="rows">
                            ...
                            <th style="width: 8%" class="thTitle">线体</th>
                            <th style="width: 18%" class="thTitle">工单</th>
                            ...
                            <th style="width: 15%" class="thTitle">可使用时间（分钟）</th>
                        </tr>
                           </thead>
                        <tbody></tbody>
                    </table>
        ...
        <script type="text/javascript">
            ...
            */
            ...
            function scrollUp() {
                ...
                //scrollElem.animate({
                //    scrollTop: scrollElem.scrollTop + 1
                //}, "slow");
        ...
        <script type="text/javascript">
            ...
            function ResizeAll() {
                ...
                if ($("#data_tbody").height() > (contentHeight.subtract(fixTopHeight))) {
                    ...
                    _InitScroll("_layout_left_data_div_tbody", "_layout_left_data_div2_tbody", $("#_layout_left_data_div2_tbody").width(), 22, 500 * 10);
                    isScroll = true;
                } else {
                    isScroll = false;
            ...
            function bulidDataTb() {
                ...
                $.ajax({
                    ...
                    data: { "api": "GetReceivingMaterialKanBan", 'lineId': lineId },
                    dataType: "Json",
                    success: function (data) {
                        ...
                        $.each(data, function (i, n) {
                            html = "<tr class=\"rows\ " + ((n["IsWarn"] == 1) ? "warn" : "") + "\">" +
                                    ...
                                    "<td style=\"width:8%\">" + n["LineName"] + "</td>" +
                                    "<td style=\"width:18%\">" + n["PlanBillNo"] + "</td>" +
                                    "<td style=\"width:15%\">" + n["EquipmentCode"] + "</td>" +
                                    "<td style=\"width:8%\">" + n["Positon"] + "</td>" +
                                    "<td style=\"width:15%\">" + n["PartNumber"] + "</td>" +
                                    "<td style=\"width:10%\">" + n["BalanceQty"] + "</td>" +
                                    "<td style=\"width:15%\">" + n["BalanceMin"] + "</td>" +
                                    "</tr>";
                            if (n["IsWarn"] == 1 && j <= 5) {
                                topHtml += html;
                            } else {
