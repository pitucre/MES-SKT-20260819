...
{
    public partial class ContainerTypeList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "ContainerTypeId";
            this.Master.DefaultSortExpression = "ContainerTypeId DESC";

            SKT.Common.Model.SearchSettings searchSettings = new SKT.Common.Model.SearchSettings();
            if (txtLayoutTypeName.Text != "")
            {
                searchSettings.AddCondition("LayoutType", this.txtLayoutTypeName.Text.Trim());
            }
            ...
            if (this.IsPostBack)
            {
                if (Request.Form["hdnOperate"].ToLower() == "delete")
                {
                    ...
                    try
                    {
                        ...
                        bll.DeleteContainerType(Request.Form["hdnIdString"].ToString(), userName);
        ...
        protected void GridView1_OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                //e.Row.Cells[5].Text = SKT.Common.Utility.TypeHelper.ToShortDateString(Convert.ToDateTime(e.Row.Cells[5].Text));
