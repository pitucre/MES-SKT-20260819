...
{
    public partial class StationTestCountList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "StationTestCountId";
            this.Master.DefaultSortExpression = "StationTestCountId DESC"; //也可不赋值
            ...
            if (IsPostBack)
            {
                if (Request.Form["hdnOperate"].ToLower() == "delete")
                {
                    ...
                    try
                    {
                        SKT.LeanMES.Station.BLL.StationTestCount bll = new SKT.LeanMES.Station.BLL.StationTestCount();
