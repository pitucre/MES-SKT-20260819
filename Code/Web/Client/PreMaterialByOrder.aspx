...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="client-center">
        ...
        <div id="activeinfo" class="active-info">
            <div id="activeinfoarea" class="active-info-area" readonly>
            </div>
        </div>
    </div>
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
            setTimeout(
                function () {
                    //加载按钮
                    loadClientButton('Pre_MaterialByOrder');
                },
                10
            );
        });
        ...
        function afterScan() {
            if ($("#txtSN").val() != "") {
                ...
                if (preCheckOrderId == -1 && preCheckItemId == -1) {
                ...
                else if (preCheckItemId == -1) {
                    //进行工单验证
                    var ajax = SKT.LeanMES.Web.AjaxServices.AjaxPreCheckMaterial.GetGRNIteminfo(1, preCheckOrderId, scanGRN);
                    if (ajax.error != null) {
                        showAreaMessge(ajax.error.Message, "scanLabelRed");
                        clearInput("txtSN");
                        //写入日志
                    ...
                    showAreaMessge(scanGRN + '验证通过', "scanLabelGreen");
                }
            }
        }
        ...
        function PrintMaterialSN() {
            ...
            if (SubmitValidation()) {
                var ajax = SKT.LeanMES.Web.AjaxServices.AjaxPreCheckMaterial.GetPrintPreMaterial("Order", stationId, resourceId, preCheckOrderId,
        ...
        function GRNScrap() {
            ...
            dialog({ title: "报废", src: openWinUrl, width: 750, height: 600 });
        }
