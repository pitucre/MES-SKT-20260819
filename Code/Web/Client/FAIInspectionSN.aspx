<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EditMaster.master" AutoEventWireup="true" CodeBehind="FAIInspectionSN.aspx.cs" Inherits="SKT.LeanMES.Web.Client.FAIInspectionSN" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="EditContent" runat="server">
    ...
    <table id="tabTmplContent" class="EditeContentTable" style="width: 100%; margin-bottom: 5px;">
        ...
        <tr>
            ...
            <td class="Field2">
             <input id="btnSaveFAICode"   onclick="saveSN()" type="button"
    ...
    <script type="text/javascript">
        ...
        $().ready(function () {
            console.log(parent.FAISNArr);
            addTrContent(parent.FAISNArr);
        ...
        function setResult(result) {
            if (result == "OK") {
                ...
                ////$("#btnSaveFAICode").attr("disabled", "disabled").attr("style", "cursor: pointer;background:#aaaaaa;border: solid 1px #aaaaaa;");
            }
            else {
                $("#chkNG").prop("checked", true);
                $("#chkOK").prop("checked", false);
                $("#txtNGCode").removeAttr("disabled");
                ////$("#btnSaveFAICode").removeAttr("disabled").attr("style", "cursor: pointer;");
            }
        ...
        function checkFAISN(sn) {
            var ajax = SKT.LeanMES.Web.AjaxServices.AjaxQC.CheckFAISN(parent.OrderId,sn);
            if (ajax.error != null) {
        ...
        function cancel(sn) {
            parent.FAISNArr.forEach(function (obj,i) {
                if (obj.SN == sn) {
                     parent.FAISNArr.splice(i, 1);
                }
            });
            addTrContent(parent.FAISNArr);
        }
