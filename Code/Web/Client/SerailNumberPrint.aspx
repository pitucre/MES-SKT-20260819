<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ProductionCollection.Master" AutoEventWireup="true" CodeBehind="SerailNumberPrint.aspx.cs" Inherits="SKT.LeanMES.Web.Client.SerailNumberPrint" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {           
            setTimeout(
                function () {
                    //加载按钮
                    loadClientButton('SerailNumberPrint');
        ...
        function afterScan() {
            if ($("#txtSN").val() != "") {
                ...
                var ajax = SKT.LeanMES.Web.AjaxServices.AjaxClientController.CheckIsExsitSN(scanSN, stationId, resourceId);
                if (ajax.error != null) {
                ...
                showAreaMessge(scanSN + ':验证通过，开始打印。如未正常调用打印机，请确认是否配置好当前工序所需打印的标签文档！', "messageGreen");
