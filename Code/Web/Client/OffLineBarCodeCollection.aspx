<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ProductionCollection.Master" AutoEventWireup="true" CodeBehind="OffLineBarCodeCollection.aspx.cs" Inherits="SKT.LeanMES.Web.Client.OffLineBarCodeCollection" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            setTimeout(
                function () {
                    //加载按钮
                    loadClientButton('OffLineBarCodeCollection');
                },
                10
            );
      ...
      **/
       ...
       **/
        ...
        function savePanel() {
            ...
            var ajax = SKT.LeanMES.Web.AjaxServices.AjaxOffLineBarCode.SaveOffLineBarCod(allScanStr, prodOrderId, stationId, resourceId, userId);
            if (ajax.error != null) {
                SaveUserUILog("一般", stationId, resourceId, "", ajax.error.Message);
                //验证失败                
