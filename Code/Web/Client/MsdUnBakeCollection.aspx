<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ProductionCollection.Master" AutoEventWireup="true" CodeBehind="MsdUnBakeCollection.aspx.cs" Inherits="SKT.LeanMES.Web.Client.MsdUnBakeCollection" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function afterScan() {
            ...
            if (grn != "") {
                ...
                //验证GRN，记录出炉信息
                var ajax = SKT.LeanMES.Web.AjaxServices.AjaxMSD.MSDUnBake(grn, stationId, resourceId);
                if (ajax.error != null) {
                    ...
                    showAreaMessge(grn + ':出烘烤箱成功！', "messageGreen");
                    setMessageBox(grn + ':出烘烤箱成功！', 'messageGreen');
                    //根据SN刷新侧边栏动态信息
