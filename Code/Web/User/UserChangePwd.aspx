<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/EditMaster.master"
    CodeBehind="UserChangePwd.aspx.cs" Inherits="SKT.LeanMES.Web.User.UserChangePwd" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="EditContent" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function Save() {
            ...
            var ajax = SKT.LeanMES.Web.AjaxServices.AjaxAccount.ChangePwd(userId, txtOldPwd ? JsDesEncrypt(txtOldPwd) : "", JsDesEncrypt(txtNewPwd), IsGroup);
            if (ajax.error != null) {
