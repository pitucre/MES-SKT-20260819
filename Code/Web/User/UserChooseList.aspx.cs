...
{
    public partial class UserChooseList : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            searchSettings.ExtensionCondition = strWhere + " [UserId] NOT IN (SELECT [UserId] FROM [SYS_UsersInRole] WHERE [RoleId] = " + Request.QueryString["ID"] + ") ";
