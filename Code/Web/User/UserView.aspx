<%@ Page Language="C#" MasterPageFile="~/Masters/ViewMaster.master" AutoEventWireup="True"
    CodeBehind="UserView.aspx.cs" Inherits="SKT.LeanMES.Web.User.UserView" Title="View Membership" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="viewcontent" runat="Server">
    <table width="100%" class="ContentTable">
        ...
        <%if(membershipInfo.UserType != -1) {%>
                <tr>
                    <td class="Label2">工号</td>
                    <td class="Field2"><asp:Label ID="lblEmployeeNo" runat="server"></asp:Label></td>
                    <td class="Label2">部门</td>
                    <td class="Field2"><asp:Label ID="lblDepartName" runat="server"></asp:Label></td>
                </tr>
           <% }%>
        <tr>
            <td class="Label2">
    ...
    <script type="text/javascript">
        function Edit() {
            openWinUrl = "<%=SKT.LeanMES.Web.WebHelper.WebRoot %>" + "/User/UserEdit.aspx?name=Account_UserEdit&ID=" + '<%= Request.QueryString["ID"] %>' + "&inMenu=true";
