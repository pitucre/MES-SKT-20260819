...
{
    public partial class InterfaceTypeModel : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "DeviceInterfaceTypeId";
            this.Master.DefaultSortExpression = "DeviceInterfaceTypeId  DESC";
            ...
            if (IsPostBack)
            {
                if (Request.Form["hdnOperate"].ToLower() == "delete")
                {
                    try
                    {
                        string ids = Request.Form["hdnIdString"].ToString().Trim();
                        SKT.LeanMES.Wave.BLL.DeviceInterfaceType bll = new SKT.LeanMES.Wave.BLL.DeviceInterfaceType();
