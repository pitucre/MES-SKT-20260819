<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ListMaster.master" AutoEventWireup="true" CodeBehind="AnormalResponseList.aspx.cs" Inherits="SKT.LeanMES.Web.Anormal.AnormalResponseList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="SearchContent" runat="server">
    ...
    <table class="EditeContentTable" width="100%">
        ...
        <tr>
            ...
            <td class="Field3">
                <asp:DropDownList ID="ddlStatus" runat="server">
                    ...
                    <asp:ListItem Value="1" Text="已建立" Selected="True"></asp:ListItem>
                    <asp:ListItem Value="3" Text="已处理"></asp:ListItem>
                    <asp:ListItem Value="2" Text="已关闭"></asp:ListItem>
                    <asp:ListItem Value="4" Text="已逾期"></asp:ListItem>
                </asp:DropDownList>
                是否停线
        ...
        <tr>
            <td class="Label3">异常处理人</td>
            <td class="Field3">
                <asp:TextBox runat="server" ID="ProcessBy" CssClass="TextBox" ClientIDMode="Static"></asp:TextBox>
            </td>
            <td class="Label3">异常响应日期</td>
            <td class="Field4">
                <asp:TextBox ID="ResponseTimeStart" runat="server" CssClass="DateTimeBox"></asp:TextBox>
                -
                <asp:TextBox ID="ResponseTimeEnd" runat="server" CssClass="DateTimeBox"></asp:TextBox>
...
<asp:Content ID="Content2" ContentPlaceHolderID="GridviewContent" runat="server">
    <asp:GridView ID="GridView1" runat="server" DataSourceID="ObjectDataSource1" DataKeyNames="AnormalObject" OnRowDataBound="GridView1_RowDataBound">
        <Columns>
    ...
    <script type="text/javascript">
        ...
        function Edit() {
            ...
            var openWinUrl = "<%=SKT.LeanMES.Web.WebHelper.WebRoot %>/Anormal/AnormalEdit.aspx?name=Anormal_Edit&ID=" + idStr + "&Flag=2";
            window.open(openWinUrl);
        }
