...
{
    public partial class AnormalTypeList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "AnormalTypeId";
            this.Master.DefaultSortExpression = "AnormalTypeId";
            ...
            if (Request.Form["hdnOperate"] != null && Request.Form["hdnOperate"].ToLower() == "delete")
            {
                ...
                try
                {
                    AnormalType bll = new AnormalType();
