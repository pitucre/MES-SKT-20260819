<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CPReinspectionHistory.aspx.cs"
    MasterPageFile="~/Masters/ListMaster.master" Inherits="SKT.LeanMES.Web.Material.CPReinspectionHistory" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="GridviewContent">
    <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound">
        <Columns>
            ...
            <asp:BoundField DataField="SerialNumber" HeaderText="工单号" />
            ...
            <asp:BoundField DataField="CreateDateTime" DataFormatString="{0:yyyy-MM-dd HH:mm:ss}" HeaderText="重检时间" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" EnablePaging="true" StartRowIndexParameterName="startRow"
        ...
        SelectMethod="GetCPReinspections" SelectCountMethod="GetCount">
        <SelectParameters>
    ...
    <script type="text/javascript" src="../Content/js/jquery-3.1.0.min.js"></script> <%-- layer不居中，需要引用jquery-3.1.0--%>
    ...
    <script type="text/javascript">
        ...
        function View() {
            ...
            var openWinUrl = "<%=SKT.LeanMES.Web.WebHelper.WebRoot %>" + "/Material/CPExpireDateEdit.aspx?type=update&GRN=" + idStr;
