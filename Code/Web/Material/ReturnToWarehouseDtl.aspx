<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReturnToWarehouseDtl.aspx.cs" MasterPageFile="~/Masters/EditMaster.master" 
    Inherits="SKT.LeanMES.Web.Material.ReturnToWarehouseDtl" %>
    ...
    <script type="text/javascript">
        ...
        function showRecDtl() {
            ...
            for (var i = 0; i < objData.length; i++) {
                var row = [];
                row.push(objData[i].ReturnOrderNo); //   data[0]
                row.push(objData[i].ItemCode); // data[1]
                row.push(objData[i].GRN); //data[2]
                row.push(objData[i].NowQty); //data[3]
