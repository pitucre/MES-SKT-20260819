<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ViewMaster.master" AutoEventWireup="true"
    CodeBehind="PrintSaleReturnGRN.aspx.cs" Inherits="SKT.LeanMES.Web.Material.PrintSaleReturnGRN" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="viewcontent" runat="server">
    ...
    <table width="100%" class="EditeContentTable">
        ...
        <tr>
            ...
            <td class="Field1">
                <input type="text" id="txtGRN" class="TextBox" style="height: 25px; width: 250px; text-transform: uppercase; font-size: 16px; font-weight: bold;" disabled/>
            </td>
        </tr>
        <tr>
