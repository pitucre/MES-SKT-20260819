<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EditMaster.master" AutoEventWireup="true"
    CodeBehind="UrgentMaterialImport.aspx.cs" Inherits="SKT.LeanMES.Web.Material.UrgentMaterialImport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="EditContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Save() {
            var ShortageXml = '<%=ShortageXml %>';
            var ajax = SKT.LeanMES.Web.AjaxServices.AjaxMaterial.ImportUrgentMaterial(ShortageXml);
            if (ajax.error != null) {
        ...
        function Download() {
            var filePath = '<%=SKT.LeanMES.Web.WebHelper.ExcelTemplateRoot+"急料模板.xlsx" %>';
