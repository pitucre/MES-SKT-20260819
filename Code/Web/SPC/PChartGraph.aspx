<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Masters.master" AutoEventWireup="true" CodeBehind="PChartGraph.aspx.cs" Inherits="SKT.LeanMES.Web.SPC.PChartGraph" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 100%; margin-top: -1px; margin-bottom: 3px;" id="xbarTb-graph">
        <tr>
            <td style="width: 100px;">
                <span style="text-decoration: overline">P</span><br />
                控<br />
                制<br />
                图<br />
            </td>
        ...
        */
        function createTable() {
                ...
                for (var j = 0; j < entity.length + 1; j++) {
                    if (j == 0) {
                        ...
                        if (i == 0) {
                            ...
                            defArr.push(decimal(def * 100, decimalPoint));                            
            ...
            if (entity.length > 0) {
                ...
                cl = decimal(cl * 100, decimalPoint);
                ucl = decimal(ucl * 100, decimalPoint);
                lcl = lcl < 0 ? 0 : decimal(lcl * 100, decimalPoint);
