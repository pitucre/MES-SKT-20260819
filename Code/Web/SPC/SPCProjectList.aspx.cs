...
{
    public partial class SPCProjectList : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Master.RecordIDField = "SPCProjectId";
            this.Master.DefaultSortExpression = "SPCProjectId DESC"; //也可不赋值

            SKT.Common.Model.SearchSettings searchSettings = new SKT.Common.Model.SearchSettings();
            searchSettings.AddCondition("ProjectName", txtSPCProjectName.Text.Trim().Replace("'", "''"));
            ...
            if (IsPostBack)
            {
                if (Request.Form["hdnOperate"].ToLower() == "delete")
                {
                    ...
                    try
                    {
                        SKT.LeanMES.SPC.BLL.SPCProject bll = new SKT.LeanMES.SPC.BLL.SPCProject();
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (string.IsNullOrEmpty(e.Row.Cells[columnIndex_ModifyBy].Text) || e.Row.Cells[columnIndex_ModifyBy].Text == "0" || e.Row.Cells[columnIndex_ModifyBy].Text == "&nbsp;")
                {
