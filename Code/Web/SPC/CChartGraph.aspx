<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Masters.master" AutoEventWireup="true" CodeBehind="CChartGraph.aspx.cs" Inherits="SKT.LeanMES.Web.SPC.CChartGraph" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 100%; margin-top: -1px; margin-bottom: 3px;" id="xbarTb-graph">
        <tr>
            <td style="width: 100px;">
                <span style="text-decoration: overline">C</span><br />
                控<br />
                制<br />
                图<br />
            </td>
    ...
    <script type="text/jscript">
        ...
        */
        function getPChartData() {
            ...
            var ajax = SKT.LeanMES.Web.AjaxServices.AjaxSPC.GetNPChartGraphData(spcTaskId);
            if (ajax.error != null) {
                alert(ajax.error.Message);
                return entity;
            }
        ...
        */
        function createTable() {
                ...
                for (var j = 0; j < entity.length + 1; j++) {
                    if (j == 0) {
                        ...
                        if (i == 0) {
                            ...
                            td = $("<td  style='color:blue;'>" + sampleQty + "</td>");
                        }
                        td.appendTo(tr);
                    }
                }
            ...
            if (entity.length > 0) {
                ...
                cl = (totalNcQty / entity.length);
                ucl = cl + 3 * Math.sqrt(cl);
                lcl = cl - 3 * Math.sqrt(cl);
