...
/*
$(function () {
$("#GridView1 tr th:last").width($(this).width());
$("#GridView1").toSuperTable({ width: "100%", height: $(window).height() - $("#searchField").height() - 98, fixedCols: 0 })
$("#NoSearchConditions").html($(".sData .ListTablePager").clone());
$(".sData .ListTablePager").hide();
