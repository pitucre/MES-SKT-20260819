/*
* 修改标识： Alen Liu 2016-12-21
*/
/*
* 设计器私有的配置说明 
* 一
* UE.uiCtrlFormDesignUrl  插件路径
* 
* 二
*UE.getEditor('myFormDesign',{
*          tooluictrl:true,//是否显示，设计器的清单 tool
*/
UE.uiCtrlFormDesignUrl = 'formdesign';
/**
* 文本框
* @command textfield
* @method execCommand
...
UE.plugins['text'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: this.options.UEDITOR_HOME_URL + UE.uiCtrlFormDesignUrl + '/text.html',
                name: thePlugins,
                editor: this,
                title: '文本框',
    ...
    me.addListener('mouseover', function (t, evt) {
        ...
        var uictrltype = el.getAttribute('uictrltype');
        if (/input/ig.test(el.tagName) && uictrltype == thePlugins) {
...
UE.plugins['macros'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: this.options.UEDITOR_HOME_URL + UE.uiCtrlFormDesignUrl + '/macros.html',
                name: thePlugins,
                editor: this,
                title: '宏控件',
...
execCommand:function () {
var dialog = new UE.ui.Dialog({
iframeUrl:this.options.UEDITOR_HOME_URL + UE.uiCtrlFormDesignUrl+'/radio.html',
name:thePlugins,
editor:this,
title: '单选框',
...
execCommand:function () {
var dialog = new UE.ui.Dialog({
iframeUrl:this.options.UEDITOR_HOME_URL + UE.uiCtrlFormDesignUrl+'/checkbox.html',
name:thePlugins,
editor:this,
title: '复选框',
...
UE.plugins['radios'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: this.options.UEDITOR_HOME_URL + UE.uiCtrlFormDesignUrl + '/radios.html',
                name: thePlugins,
                editor: this,
                title: '单选框组',
                cssRules: "width:590px;height:370px;",
    ...
    me.addListener('mouseover', function (t, evt) {
        ...
        var el = evt.target || evt.srcElement;
        var uictrltype = el.getAttribute('uictrltype');
        if (/span/ig.test(el.tagName) && uictrltype == thePlugins) {
            var html = popup.formatHtml(
...
UE.plugins['checkboxs'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: this.options.UEDITOR_HOME_URL + UE.uiCtrlFormDesignUrl + '/checkboxs.html',
                name: thePlugins,
                editor: this,
                title: '复选框组',
...
UE.plugins['textarea'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: this.options.UEDITOR_HOME_URL + UE.uiCtrlFormDesignUrl + '/textarea.html',
                name: thePlugins,
                editor: this,
                title: '多行文本框',
...
UE.plugins['select'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: this.options.UEDITOR_HOME_URL + UE.uiCtrlFormDesignUrl + '/select.html',
                name: thePlugins,
                editor: this,
                title: '下拉菜单',
                cssRules: "width:590px;height:370px;",
    ...
    me.addListener('mouseover', function (t, evt) {
        ...
        var el = evt.target || evt.srcElement;
        var uictrltype = el.getAttribute('uictrltype');
        if (/select|span/ig.test(el.tagName) && uictrltype == thePlugins) {
            var html = popup.formatHtml(
...
UE.plugins['listctrl'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: this.options.UEDITOR_HOME_URL + UE.uiCtrlFormDesignUrl + '/listctrl.html',
                name: thePlugins,
                editor: this,
                title: '列表控件',
...
/**
* 表格控件 Add By Alen Liu 2016-12-28
* @command gridctrl
* @method execCommand
* @param { String } cmd 命令字符串
* @example
* ```javascript
* editor.execCommand( 'gridctrl');
* ```
*/
UE.plugins['gridctrl'] = function () {
    var me = this, thePlugins = 'gridctrl';
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: this.options.UEDITOR_HOME_URL + UE.uiCtrlFormDesignUrl + '/gridctrl.html',
                name: thePlugins,
                editor: this,
                title: '表格控件',
                cssRules: "width:800px;height:400px;",
    ...
    me.addListener('mouseover', function (t, evt) {
        ...
        if (/input/ig.test(el.tagName) && uictrltype == thePlugins) {
            var html = popup.formatHtml(
                '<nobr>表格控件: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>');
            if (html) {
                popup.getDom('content').innerHTML = html;
                popup.anchorEl = el;
                popup.showAnchor(popup.anchorEl);
...
/**
* 按钮控件 Add By Alen Liu 2016-12-28
* @command btnctrl
* @method execCommand
* @param { String } cmd 命令字符串
* @example
* ```javascript
* editor.execCommand( 'btnctrl');
* ```
*/
UE.plugins['btnctrl'] = function () {
    var me = this, thePlugins = 'btnctrl';
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: this.options.UEDITOR_HOME_URL + UE.uiCtrlFormDesignUrl + '/btnctrl.html',
                name: thePlugins,
                editor: this,
                title: '按钮控件',
                cssRules: "width:600px;height:310px;",
...
/**
* 弹窗控件 Add By Alen Liu 2016-12-28
* @command choosepagectrl
* @method execCommand
* @param { String } cmd 命令字符串
* @example
* ```javascript
* editor.execCommand( 'choosepagectrl');
* ```
*/
UE.plugins['choosepagectrl'] = function () {
    var me = this, thePlugins = 'choosepagectrl';
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: this.options.UEDITOR_HOME_URL + UE.uiCtrlFormDesignUrl + '/choosepagectrl.html',
                name: thePlugins,
                editor: this,
                title: '弹窗控件',
                cssRules: "width:600px;height:310px;",
    ...
    me.addListener('mouseover', function (t, evt) {
        ...
        if (/span/ig.test(el.tagName) && uictrltype == thePlugins) {
            var html = popup.formatHtml(
				'<nobr>弹窗控件: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>');
...
/**
* 打印控件 Add By wenshun 2016-12-28
* @command printctrl
* @method execCommand
* @param { String } cmd 命令字符串
* @example
* ```javascript
* editor.execCommand( 'printctrl');
* ```
*/
UE.plugins['printctrl'] = function () {
    var me = this, thePlugins = 'printctrl';
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({                
                iframeUrl: this.options.UEDITOR_HOME_URL + UE.uiCtrlFormDesignUrl + '/printctrl.html',
                name: thePlugins,
                editor: this,
                title: '打印控件',
                cssRules: "width:600px;height:310px;",
    ...
    me.addListener('mouseover', function (t, evt) {
        ...
        if (/input/ig.test(el.tagName) && uictrltype == thePlugins) {
            var html = popup.formatHtml(
				'<nobr>打印控件: <span onclick=$$._edittext() class="edui-clickable">编辑</span>&nbsp;&nbsp;<span onclick=$$._delete() class="edui-clickable">删除</span></nobr>');
            if (html) {
                popup.getDom('content').innerHTML = html;
                popup.anchorEl = el;
                popup.showAnchor(popup.anchorEl);
...
UE.plugins['error'] = function () {
    ...
    me.commands[thePlugins] = {
        execCommand: function () {
            var dialog = new UE.ui.Dialog({
                iframeUrl: this.options.UEDITOR_HOME_URL + UE.uiCtrlFormDesignUrl + '/error.html',
                name: thePlugins,
                editor: this,
                title: '异常提示',
...
UE.registerUI('button_template', function (editor, uiName) {
    ...
    editor.registerCommand(uiName, {
        execCommand: function () {
            try {
                uiCtrlFormDesign.exec('leipi_template');
                //uiCtrlFormDesign.fnCheckForm('save');
            } catch (e) {
                alert('打开模板异常');
            }
    ...
    editor.registerCommand(uiName, {
        execCommand: function () {
            try {
                ...
                uiFormDesign.fnReview();
            } catch (e) {
                alert(e); //'uiCtrlFormDesign.fnReview 预览异常'
            }
        }
    });
    //创建一个button
...
UE.registerUI('button_save', function (editor, uiName) {
    ...
    editor.registerCommand(uiName, {
        execCommand: function () {
            try {
                uiFormDesign.fnCheckForm('save');
                //uiCtrlFormDesign.fnCheckForm('save');
            } catch (e) {
                alert('uiFormDesign.fnCheckForm("save") 保存异常');
            }
