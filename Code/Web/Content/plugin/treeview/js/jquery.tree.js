...
(function ($) {
    ...
    $.fn.treeview = function (settings) {
        ...
        function buildnode(nd, ht, deep, path, isend) {
            ...
            if (nd.isSelected) {
                ht.push("<li class='bbit-tree-node bbit-tree-selected'>");
            }
            else {
                ht.push("<li class='bbit-tree-node'>");
            }
            ht.push("<div id='", id, "_", nid, "' tpath='", path, "' unselectable='on'"); //Modify By Alen 2014-11-19
            ...
            //if (nd.isSelected) {
            if (deep == 3) {
                if (nd.isDefault != undefined && nd.isDefault == true) {
                    ht.push("<img class='bbit-tree-node-icon-default' title='默认模板'  src='", dfop.emptyiconpath, "'/>");
                }
                else {
            ...
            //}
            //else {
            //    ht.push("<img class='bbit-tree-node-icon1' src='", dfop.emptyiconpath, "'/>");
            //}
            //checkbox
            ...
            if (deep == 1) {
                ht.push("<span  id='" + nd.id + "' unselectable='on' class='swt'>", nd.text, "</span>");
            }
            else {
                if (deep == 3) {
                    ht.push("<span class='bbit-tree-node-text' unselectable='on' onclick='showTemplate(\"" + nd.id + "\",this)'>", nd.text, "</span>");
                } else {
