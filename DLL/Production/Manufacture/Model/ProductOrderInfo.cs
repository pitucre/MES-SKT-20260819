...
namespace SKT.LeanMES.Manufacture.Model
{
    ...
    public class ProductOrderInfo
    {
        ...
        /// <summary>
        /// 初始化 SKT.MES.Model.ORDERInfo 类的新实例。
        /// </summary>
        ...
        /// <param name="orderType">工单类型(1:normal  2:RMA)</param>
        ...
        /// <param name="customerOrderQty">客户订单数量</param>
        ...
        public ProductOrderInfo(Int32 prodOrderID, String orderNO, Int32 orderType, Int32 status, 
            Int32 priority, Int32 itemId, Int32 bOMId, Int32 routerId, Int32 customerID, 
            String customerOrder, Int32 customerOrderQty, Int32 qty_to_Build, Int32 qty_Released, Int32 qty_Done, 
            Int32 qty_Scrapped, DateTime release_date, DateTime planned_Start_Time, DateTime planned_Completed_Date, DateTime scheduled_Start_Date, 
            DateTime scheduled_Completed_Time, DateTime actual_Start_Date, DateTime actual_Completed_Date, String createBy, DateTime createTime, 
            String modifyBy, DateTime modifyTime)
        {
