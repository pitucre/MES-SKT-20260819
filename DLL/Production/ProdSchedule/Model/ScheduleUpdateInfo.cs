...
namespace SKT.LeanMES.Schedule.Model
{
    ...
    public class ScheduleUpdateInfo
    {
        ...
        /// <summary>
        /// 初始化 SKT.LeanMES.Schedule.Model.ScheduleUpdateInfo 类的新实例。
        /// </summary>
        public ScheduleUpdateInfo()
        {
        }
        ...
        public ScheduleUpdateInfo(Decimal mPID, DateTime creatDate, String moCode, String busType, 
            ...
            DateTime planBeginDate, DateTime planEndTime, DateTime modifyDate, String memo, String define1, 
            String define2, String define3, String define4, String define5, String define6, 
            Int32 define7, Int32 define8, DateTime define9, DateTime define10, String pubufts,
            Int32 state, Decimal sortSeq)
        {
            this.mPID = mPID;
