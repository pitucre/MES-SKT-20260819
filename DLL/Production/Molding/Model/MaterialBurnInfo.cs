...
namespace SKT.LeanMES.Molding.Model
{
    ...
    /// </summary>
    [Serializable]
    public class MaterialBurnInfo : CommEntity
    {
        /// <summary>
        /// 烧录ID
        /// </summary>
        ...
        public MaterialBurnInfo() { }

        public MaterialBurnInfo(Int32 burnId, String softName, string softCreator, String testMachine, String customer,
