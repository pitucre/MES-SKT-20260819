...
namespace SKT.LeanMES.Customer.BLL
{
    public class Customer
    {
        ...
        public  void  Edit(CustomerInfo entity)
        {
            SqlParameter[] parms = new SqlParameter[]{
                ...
                new SqlParameter("@CustomerCode", SqlDbType.VarChar, 20)
            };

            parms[0].Value = entity.CustomerID;
            parms[1].Value = entity.CustomerName.Trim();
            ...
            parms[12].Value = entity.CustomerCode;
        ...
        public CustomerInfo GetInfo(Int32 customerId)
        {
            ...
            using (SqlDataReader rdr = SQLHelper.ExecuteReaderStoredProcedure(SQLHelper.MESConnString, "Basal_Customer_GetInfo", parms))
            {
                if (rdr.Read())
                {
                    ...
                    entity.CustomerCode = rdr.GetString(14);
                }
                rdr.Close();
            }
        ...
        public List<CustomerInfo> GetAll(Int32 startRow, Int32 maxRows, String sortExpression, SearchSettings searchSettings)
        {
            ...
            SqlParameter[] parms = SQLHelper.CreateCommonPagingStoredProcedureParameters(startRow, maxRows, "vwBasal_Customer", "CustomerId",////Basal_Customer
                "[CustomerID], [CustomerName], [Address1], [Address2], [City], [StateProvince], [Country], [Postal], [EmailAddress], [Remark], [ModifyDateTime], [ModifyBy], [CreateDateTime], [CreateBy], CustomerCode", searchSettings, sortExpression);
            ...
            using (SqlDataReader rdr = SQLHelper.ExecuteReaderStoredProcedure(SQLHelper.MESConnString, "Common_GetPageRecords", parms))
            {
                while (rdr.Read())
                {
                    entity = new CustomerInfo(rdr.GetInt32(0), rdr.GetString(1), rdr.GetString(2), rdr.GetString(3), rdr.GetString(4), 
                        rdr.GetString(5), rdr.GetString(6), rdr.GetString(7), rdr.GetString(8), rdr.GetString(9), 
                        rdr.GetDateTime(10), rdr.GetString(11), rdr.GetDateTime(12), rdr.GetString(13));
                    entity.CustomerCode = rdr["CustomerCode"] == DBNull.Value || rdr["CustomerCode"] == null ? string.Empty : rdr["CustomerCode"].ToString();
                    list.Add(entity);
                }
                rdr.Close();
            }
