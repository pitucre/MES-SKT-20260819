...
{
    [Serializable]
    public class SupplierExameContentResultHistoryInfo
    {
        private Int32 supplierExameContentResultHistoryID;
        ...
        /// <summary>
        /// 初始化 SKT.LeanMES.Model.SupplierExameContentResultHistoryInfo 类的新实例。
        /// </summary>
        public SupplierExameContentResultHistoryInfo()
        {
        }
        ...
        /// 初始化 SKT.LeanMES.Model.SupplierExameContentResultHistoryInfo 类的新实例。
        /// </summary>
        /// <param name="supplierExameContentResultHistoryID">考核历史ID</param>
        ...
        public SupplierExameContentResultHistoryInfo(Int32 supplierExameContentResultHistoryID, Int32 supplierExameContentResultID, Int32 supplierExameResultID, Int32 batchID, 
            Int32 supplierExameContentId, String supplierExameName, String supplierExameType, String supplierExameCompute, Decimal grades, 
            Decimal weightGrades, Int32 sorting, String createBy, DateTime createDateTime)
        {
            this.supplierExameContentResultHistoryID = supplierExameContentResultHistoryID;
        ...
        /// 获取或设置考核历史ID
        /// </summary>
        public Int32 SupplierExameContentResultHistoryID
        {
            get { return this.supplierExameContentResultHistoryID; }
            set { this.supplierExameContentResultHistoryID = value; }
        }
