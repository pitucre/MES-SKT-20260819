...
namespace SKT.LeanMES.Resource.Model
{
    ...
    public class ResourceInfo
    {
        ...
        //Add By Alen 2016-06-18
        private string resTypeName;
        private int resTypeId;

        /// <summary>
        /// 初始化 SKT.LeanMES.Resource.Model.ResourceInfo 类的新实例。
        /// </summary>
        public ResourceInfo()
        {
        }
        ...
        {
            set { this.modify_Ver = value; }
            get { return this.modify_Ver; }
        }
        ...
        public Int32 ResTypeId
        {
            set { this.resTypeId = value; }
            get { return this.resTypeId; }
        }
        /// <summary>
        /// 面别
        /// </summary>
