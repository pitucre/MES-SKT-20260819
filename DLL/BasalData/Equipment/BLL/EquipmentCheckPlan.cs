...
{
    public class EquipmentCheckPlan
    {
        ...
        public List<EquipmentCheckOutPlanInfo> GetAll(Int32 startRow, Int32 maxRows, String sortExpression, SearchSettings searchSettings)
        {
            ...
            SqlParameter[] parms = SQLHelper.CreateCommonPagingStoredProcedureParameters(startRow, maxRows, "vwEquipmentCheckOutPlan", "EquipmentCheckOutPlanId",
                "[EquipmentCheckOutPlanId], [EqCode], [CheckType], [CheckProject], [CycleType], [Cycle], [LastTime], [NextTime], [CreateBy], [CreateTime],CheckTypeName,CycleTypeName,CheckOutProjectName,EquipmentName,ObjectType,ObjectTypeName,EquipmentType,EquipmentTypeName", searchSettings, sortExpression);
