...
namespace SKT.LeanMES.DataType.BLL
{
    public class DataType
    {
        ...
        public Int32 Edit(DataTypeInfo entity, String action, Int32 oldRecordId)
        {
            SqlParameter[] parms = new SqlParameter[]{
                new SqlParameter("@DataTypeId", SqlDbType.Int),
                new SqlParameter("@Category", SqlDbType.VarChar, 20),
                new SqlParameter("@DataTypeName", SqlDbType.VarChar, 30),
                new SqlParameter("@Description", SqlDbType.NVarChar, 50),
                new SqlParameter("@ValidationActivity", SqlDbType.VarChar, 50),
            ...
            parms[2].Value = entity.DataTypeName;
            parms[3].Value = entity.Description;
            parms[4].Value = entity.ValidationActivity;
            parms[5].Value = entity.Remark;
            parms[6].Value = entity.ModifyBy;
            parms[7].Value = entity.CreateBy;
            parms[8].Value = action;
            parms[9].Value = oldRecordId;
        ...
        public List<DataTypeInfo> GetAll(Int32 startRow, Int32 maxRows, String sortExpression, SearchSettings searchSettings)
        {
            ...
            SqlParameter[] parms = SQLHelper.CreateCommonPagingStoredProcedureParameters(startRow, maxRows, "vwBasal_DataType", "DataTypeId",////Basal_DataType
                "[DataTypeId], [Category], [DataTypeName], [Description], [ValidationActivity], [Remark], [ModifyDateTime], [ModifyBy], [CreateDateTime], [CreateBy]", searchSettings, sortExpression);
