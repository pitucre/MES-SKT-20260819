...
namespace SKT.LeanMES.Quality.BLL
{
    public class InspectionType
    {
        ...
        public Int32 Edit(string strJson)
        {
            ...
            ComMethod.Edit<InspectionTypeInfo>(strJson, "Quality_InspectionType_Edit", parms);			
        ...
        {
            ComMethod.Delete(idString, userName, "Quality_InspectionType_Delete");
        }
        ...
        public InspectionTypeInfo GetInfo(Int32 inspectionTypeId)
        {
            return ComMethod.GetInfo<InspectionTypeInfo>(inspectionTypeId, "Quality_InspectionType_GetInfo");
        }
        ...
        /// <returns>InspectionType 实体对象。</returns>
        public InspectionTypeInfo GetInfo(String fieldValue)
        {
            return ComMethod.GetInfo<InspectionTypeInfo>(fieldValue, "Quality_InspectionType_GetInfo");
        }
        ...
        public List<InspectionTypeInfo> GetAll(Int32 startRow, Int32 maxRows, String sortExpression, SearchSettings searchSettings)
        {
            List<InspectionTypeInfo> list = new List<InspectionTypeInfo>();
            //表名或者视图
            string strTb = "vwQualityInspectionType";
            //主键
            ...
            list = ComMethod.GetComList<InspectionTypeInfo>(ref recordCount, startRow, maxRows, strTb, strKey, strColumns, sortExpression, searchSettings);
